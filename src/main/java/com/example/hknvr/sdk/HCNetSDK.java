...
//智能设备类型
    ...
    @Structure.FieldOrder({"byStartHour","byStartMin","byStopHour","byStopMin"})
    ...
    @Structure.FieldOrder({"dwHandleType","byRelAlarmOut"})
    ...
    //DVR设备参数
    @Structure.FieldOrder({"dwSize","sDVRName","dwDVRID","dwRecycleRecord","sSerialNumber","dwSoftwareVersion","dwSoftwareBuildDate","dwDSPSoftwareVersion","dwDSPSoftwareBuildDate","dwPanelVersion","dwHardwareVersion","byAlarmInPortNum","byAlarmOutPortNum","byRS232Num","byRS485Num","byNetworkPortNum","byDiskCtrlNum","byDiskNum","byDVRType","byChanNum","byStartChan","byDecordChans","byVGANum","byUSBNum","byAuxoutNum","byAudioNum","byIPChanNum"})
    ...
    @Structure.FieldOrder({"sIpV4","byRes"})
    ...
    //网络数据结构(子结构)(9000扩展)
    @Structure.FieldOrder({"struDVRIP","struDVRIPMask","dwNetInterface","wDVRPort","wMTU","byMACAddr"})
    ...
    @Structure.FieldOrder({"sDVRIP","sDVRIPMask","dwNetInterface","wDVRPort","byMACAddr"})
    ...
    @Structure.FieldOrder({"dwPPPoE","sPPPoEUser","sPPPoEPassword","struPPPoEIP"})
    ...
    @Structure.FieldOrder({"dwSize","struEtherNet","struRes1","struAlarmHostIpAddr","wRes2","wAlarmHostIpPort","byUseDhcp","byRes3","struDnsServer1IpAddr","struDnsServer2IpAddr","byIpResolver","wIpResolverPort","wHttpPortNo","struMulticastIpAddr","struGatewayIpAddr","struPPPoE","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struEtherNet","sManageHostIP","wManageHostPort","sIPServerIP","sMultiCastIP","sGatewayIP","sNFSIP","sNFSDirectory","dwPPPOE","sPPPoEUser","sPPPoEPassword","sPPPoEIP"})
    ...
    //通道图象结构
    @Structure.FieldOrder({"struAlarmTime"})
    ...
    @Structure.FieldOrder({"byMotionScope"})
    ...
    @Structure.FieldOrder({"byMotionScope","byMotionSensitive","byEnableHandleMotion","byPrecision","reservedData","struMotionHandleType","struAlarmTime","byRelRecordChan"})
    ...
    @Structure.FieldOrder({"byMotionScope","byMotionSensitive","byEnableHandleMotion","reservedData","strMotionHandleType","byRelRecordChan"})
    ...
    @Structure.FieldOrder({"dwEnableHideAlarm","wHideAlarmAreaTopLeftX","wHideAlarmAreaTopLeftY","wHideAlarmAreaWidth","wHideAlarmAreaHeight","strHideAlarmHandleType","struAlarmTime"})
    ...
    @Structure.FieldOrder({"dwEnableHideAlarm","wHideAlarmAreaTopLeftX","wHideAlarmAreaTopLeftY","wHideAlarmAreaWidth","wHideAlarmAreaHeight","strHideAlarmHandleType"})
    ...
    @Structure.FieldOrder({"byEnableHandleVILost","strVILostHandleType","struAlarmTime"})
    ...
    @Structure.FieldOrder({"byEnableHandleVILost","strVILostHandleType"})
    ...
    @Structure.FieldOrder({"wHideAreaTopLeftX","wHideAreaTopLeftY","wHideAreaWidth","wHideAreaHeight"})
    ...
    @Structure.FieldOrder({"byBrightness","byContrast","bySaturation","byHue"})
    ...
    @Structure.FieldOrder({"struColor","struHandleTime"})
    ...
    //信号丢失
    @Structure.FieldOrder({"dwEnableVILostAlarm","dwHandleType","dwMaxRelAlarmOutChanNum","dwRelAlarmOut","struAlarmTime","byVILostAlarmThreshold","byRes"})
    ...
    @Structure.FieldOrder({"byObjectSize","byMotionSensitive","byRes"})
    ...
    @Structure.FieldOrder({"byAreaNo","byRes","struRect","struDayNightDisable","struDayModeParam","struNightModeParam","byRes1"})
    ...
    @Structure.FieldOrder({"byDayNightCtrl","byAllMotionSensitive","byRes","struScheduleTime","struMotionMultiAreaParam","byRes1"})
    ...
    @Structure.FieldOrder({"byMotionScope","byMotionSensitive","byRes"})
    ...
    @Structure.FieldOrder({"struMotionSingleArea","struMotionMultiArea"})
    ...
    @Structure.FieldOrder({"struMotionMode","byEnableHandleMotion","byEnableDisplay","byConfigurationMode","byKeyingEnable","dwHandleType","dwMaxRelAlarmOutChanNum","dwRelAlarmOut","struAlarmTime","dwMaxRecordChanNum","dwRelRecordChan","byDiscardFalseAlarm","byRes"})
    ...
    @Structure.FieldOrder({"byRed","byGreen","byBlue","byRes"})
    ...
    @Structure.FieldOrder({"dwEnableHideAlarm","wHideAlarmAreaTopLeftX","wHideAlarmAreaTopLeftY","wHideAlarmAreaWidth","wHideAlarmAreaHeight","dwHandleType","dwMaxRelAlarmOutChanNum","dwRelAlarmOut","struAlarmTime","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sChanName","dwVideoFormat","struViColor","dwShowChanName","wShowNameTopLeftX","wShowNameTopLeftY","dwEnableHide","struShelter","dwShowOsd","wOSDTopLeftX","wOSDTopLeftY","byOSDType","byDispWeek","byOSDAttrib","byHourOSDType","byFontSize","byOSDColorType","byAlignment","byOSDMilliSecondEnable","struVILost","struAULost","struMotion","struHideAlarm","struOsdColor","dwBoundary","struOsdBkColor","byOSDBkColorMode","byUpDownBoundary","byLeftRightBoundary","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sChanName","dwVideoFormat","struViColor","dwShowChanName","wShowNameTopLeftX","wShowNameTopLeftY","struVILost","struAULost","struMotion","struHideAlarm","dwEnableHide","struShelter","dwShowOsd","wOSDTopLeftX","wOSDTopLeftY","byOSDType","byDispWeek","byOSDAttrib","byHourOSDType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sChanName","dwVideoFormat","byBrightness","byContrast","bySaturation","byHue","dwShowChanName","wShowNameTopLeftX","wShowNameTopLeftY","struVILost","struMotion","struHideAlarm","dwEnableHide","struShelter","dwShowOsd","wOSDTopLeftX","wOSDTopLeftY","byOSDType","byDispWeek","byOSDAttrib","byHourOsdType"})
    ...
    @Structure.FieldOrder({"dwSize","sChanName","dwVideoFormat","byBrightness","byContrast","bySaturation","byHue","dwShowChanName","wShowNameTopLeftX","wShowNameTopLeftY","struVILost","struMotion","struHideAlarm","dwEnableHide","wHideAreaTopLeftX","wHideAreaTopLeftY","wHideAreaWidth","wHideAreaHeight","dwShowOsd","wOSDTopLeftX","wOSDTopLeftY","byOSDType","reservedData2"})
    ...
    @Structure.FieldOrder({"dwSize","struStreamInfo","dwStreamType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwStreamType","struStreamPara","byRes"})
    ...
    //码流压缩参数(子结构)(9000扩展)
    @Structure.FieldOrder({"byStreamType","byResolution","byBitrateType","byPicQuality","dwVideoBitrate","dwVideoFrameRate","wIntervalFrameI","byIntervalBPFrame","byENumber","byVideoEncType","byAudioEncType","byres"})
    ...
    //通道压缩参数(9000扩展)
    @Structure.FieldOrder({"dwSize","struNormHighRecordPara","struRes","struEventRecordPara","struNetPara"})
    ...
    @Structure.FieldOrder({"byStreamType","byResolution","byBitrateType","byPicQuality","dwVideoBitrate","dwVideoFrameRate"})
    ...
    @Structure.FieldOrder({"dwSize","struRecordPara","struNetPara"})
    ...
    @Structure.FieldOrder({"byStreamType","byResolution","byBitrateType","byPicQuality","dwVideoBitrate","dwVideoFrameRate","wIntervalFrameI","byIntervalBPFrame","byENumber"})
    ...
    @Structure.FieldOrder({"struRecordTime", "byRecordType", "reservedData"})
    ...
    @Structure.FieldOrder({"wAllDayRecord", "byRecordType", "reservedData"})
    ...
    @Structure.FieldOrder({"struRecordSched"})
    ...
    @Structure.FieldOrder({"dwSize","dwRecord","struRecAllDay","struRecordSched","dwRecordTime","dwPreRecordTime","dwRecorderDuration","byRedundancyRec","byAudioRec","byReserve"})
    ...
    @Structure.FieldOrder({"dwSize","dwRecord","struRecAllDay","struRecordSched","dwRecordTime","dwPreRecordTime"})
    ...
    @Structure.FieldOrder({"dwRelativeTime","dwAbsTime","byRes"})
    ...
    @Structure.FieldOrder({"tmStart","tmEnd","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byMode","byChannel","bySmart","byRes1","struDevInfo","uStatModeParam","dwLeaveNum","dwEnterNum","byBrokenNetHttp","byRes3","wDevInfoIvmsChannelEx","dwPassingNum","dwChildLeaveNum","dwChildEnterNum","dwDuplicatePeople","dwXmlLen","pXmlBuf","byRes2"})
    ...
    //云台协议表结构配置
    @Structure.FieldOrder({"dwType","byDescribe"})
    ...
    @Structure.FieldOrder({"dwSize","struPtz","dwPtzNum","byRes"})
     ...
     * 云台类型(end)
     ******************************/
    @Structure.FieldOrder({"dwSize","dwBaudRate","byDataBit","byStopBit","byParity","byFlowcontrol","wDecoderType","wDecoderAddress","bySetPreset","bySetCruise","bySetTrack"})
    ...
    @Structure.FieldOrder({"struRemoteIP","struLocalIP","sLocalIPMask","sUsername","sPassword","byPPPMode","byRedial","byRedialMode","byDataEncrypt","dwMTU","sTelephoneNumber"})
    ...
    @Structure.FieldOrder({"sRemoteIP","sLocalIP","sLocalIPMask","sUsername","sPassword","byPPPMode","byRedial","byRedialMode","byDataEncrypt","dwMTU","sTelephoneNumber"})
    ...
    @Structure.FieldOrder({"dwBaudRate","byDataBit","byStopBit","byParity","byFlowcontrol","dwWorkMode"})
    ...
    @Structure.FieldOrder({"dwSize","struRs232","byRes","struPPPConfig"})
    ...
    @Structure.FieldOrder({"dwSize","dwBaudRate","byDataBit","byStopBit","byParity","byFlowcontrol","dwWorkMode","struPPPConfig"})
    ...
    @Structure.FieldOrder({"dwSize","sAlarmInName","byAlarmType","byAlarmInHandle","reservedData","struAlarmHandleType","struAlarmTime","byRelRecordChan","byEnablePreset","byPresetNo","byEnablePresetRevert","wPresetRevertDelay","byEnableCruise","byCruiseNo","byEnablePtzTrack","byPTZTrack","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sAlarmInName","byAlarmType","byAlarmInHandle","struAlarmHandleType","struAlarmTime","byRelRecordChan","byEnablePreset","byPresetNo","byEnableCruise","byCruiseNo","byEnablePtzTrack","byPTZTrack"})
    ...
    @Structure.FieldOrder({"sDevName","dwSpeed","dwLongitude","dwLatitude","direction","res"})
    ...
    @Structure.FieldOrder({"bySubAlarmType","byRes1","struRecordEndTime"})
    ...
    @Structure.FieldOrder({"dwAlarmHardDiskNum"})
    ...
    @Structure.FieldOrder({"dwAlarmChanNum","dwPicLen","byPicURL","byTarget","byRes1","pDataBuff"})
    ...
    @Structure.FieldOrder({"dwAlarmInputNo","dwTrigerAlarmOutNum","dwTrigerRecordChanNum"})
    ...
    @Structure.FieldOrder({"wYear","byMonth","byDay","byHour","byMinute","bySecond","byRes"})
    ...
    @Structure.FieldOrder({"dwAlarmType","struAlarmTime","ustruAlarm","pRes","byTimeDiffFlag","cTimeDifferenceH","cTimeDifferenceM","byRes","wDevInfoIvmsChannel","byRes2"})
    ...
    @Structure.FieldOrder({"struAlarmFixedHeader","pAlarmData"})
    ...
    @Structure.FieldOrder({"dwAlarmType","dwAlarmInputNumber","byAlarmOutputNumber","byAlarmRelateChannel","byChannel","byDiskNumber"})
    ...
    @Structure.FieldOrder({"dwAlarmType","dwAlarmInputNumber","dwAlarmOutputNumber","dwAlarmRelateChannel","dwChannel","dwDiskNumber"})
    ...
    @Structure.FieldOrder({"dwAlarmType","dwAlarmInputNumber","dwAlarmOutputNumber","dwAlarmRelateChannel","dwChannel","dwDiskNumber","sSerialNumber","sRemoteAlarmIP"})
    ...
    //IPC接入参数配置
    @Structure.FieldOrder({"dwEnable","sUserName","sPassword","struIP","wDVRPort","byres"})
    ...
    /* IP通道匹配参数 */
    @Structure.FieldOrder({"byEnable","byIPID","byChannel","byIPIDHigh","byTransProtocol","byGetStream","byres"})
    ...
    @Structure.FieldOrder({"dwSize","struIPDevInfo","byAnalogChanEnable","struIPChanInfo"})
    ...
    @Structure.FieldOrder({"byEnable","byProType","byEnableQuickAdd","byRes1","sUserName","sPassword","byDomain","struIP","wDVRPort","szDeviceID","byRes2"})
    ...
    @Structure.FieldOrder({"byGetStreamType","byRes","uGetStream"})
    ...
    @Structure.FieldOrder({"byEnable", "byRes", "struIPServer", "wPort", "wDvrNameLen", "byDVRName", "wDVRSerialLen", "byRes1", "byDVRSerialNumber", "byUserName", "byPassWord", "byChannel", "byRes2"})
    ...
    @Structure.FieldOrder({"byValid", "byRes1", "struDevIP", "wDevPort", "byTransmitType", "byRes2"})
    ...
    @Structure.FieldOrder({"struIP", "wDVRPort", "byChannel", "byTransProtocol", "byTransMode", "byFactoryType", "byDeviceType", "byDispChan", "bySubDispChan", "byResolution", "byRes", "byDomain", "sUserName", "sPassword"})
    ...
    @Structure.FieldOrder({"dwSize", "struStreamMediaSvrCfg", "struDevChanInfo"})
    ...
    @Structure.FieldOrder({"dwSize", "byStreamMode", "byStreamEncrypt", "byRes1", "uDecStreamMode", "dwDecDelayTime", "sStreamPassword", "byRes2"})
    ...
    @Structure.FieldOrder({"byEnable", "byRes1", "struStreamServer", "wStreamServerPort", "byStreamServerTransmitType", "byRes2", "struIPServer", "wIPServerPort", "byRes3", "sDVRName", "wDVRNameLen", "wDVRSerialLen", "sDVRSerialNumber", "sUserName", "sPassWord", "wDVRPort", "byRes4", "byChannel", "byTransProtocol", "byTransMode", "byFactoryType"})
    ...
    @Structure.FieldOrder({"byEnable", "strURL", "byTransPortocol", "wIPID", "byChannel", "byRes"})
    ...
    @Structure.FieldOrder({"byEnable", "byRes", "byDDNSDomain", "wPort", "wAliasLen", "byAlias", "wDVRSerialLen", "byRes1", "byDVRSerialNumber", "byUserName", "byPassWord", "byChannel", "byRes2"})
    ...
    @Structure.FieldOrder({"byEnable", "byRes1", "wIPID", "dwChannel", "byTransProtocol", "byTransMode", "byFactoryType", "byRes"})
    ...
    @Structure.FieldOrder({"struChanInfo","struIPChan","byUnionLen"})
    public static class NET_DVR_GET_STREAM_UNION extends Union {
        public NET_DVR_GET_STREAM_UNION() { super(); }
    ...
    @Structure.FieldOrder({"dwSize","dwGroupNum","dwAChanNum","dwDChanNum","dwStartDChan","byAnalogChanEnable","struIPDevInfo","struStreamMode","byRes2"})
    ...
    @Structure.FieldOrder({"byIPID","byAlarmOut","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struIPAlarmOutInfo"})
    ...
    @Structure.FieldOrder({"byIPID","byAlarmIn","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struIPAlarmInInfo"})
    ...
    @Structure.FieldOrder({"struIPDevInfo","byAnalogChanEnable","struIPChanInfo","struIPAlarmInInfo","struIPAlarmOutInfo"})
    ...
    @Structure.FieldOrder({"dwHDNo","dwCapacity","dwFreeSpace","dwHdStatus","byHDAttr","byRes1","dwHdGroup","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwHDCount","struHDInfo"})
    ...
    @Structure.FieldOrder({"dwHDGroupNo","byHDGroupChans","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwHDGroupCount","struHDGroupAttr"})
    ...
    @Structure.FieldOrder({"dwSize","dwMajorScale","dwMinorScale","dwRes"})
    ...
    @Structure.FieldOrder({"dwSize","sAlarmOutName","dwAlarmOutDelay","struAlarmOutTime","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sAlarmOutName","dwAlarmOutDelay","struAlarmOutTime"})
    ...
    @Structure.FieldOrder({"dwSize","byPreviewNumber","byEnableAudio","wSwitchTime","bySwitchSeq","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byPreviewNumber","byEnableAudio","wSwitchTime","bySwitchSeq"})
    ...
    @Structure.FieldOrder({"wResolution","wFreq","dwBrightness"})
     ...
     * MATRIX输出参数结构
     */
    @Structure.FieldOrder({"wOrder","wSwitchTime","res"})
    ...
    @Structure.FieldOrder({"wDisplayLogo","wDisplayOsd"})
    ...
    @Structure.FieldOrder({"byVideoFormat","byMenuAlphaValue","wScreenSaveTime","wVOffset","wBrightness","byStartMode","byEnableScaler"})
    ...
    @Structure.FieldOrder({"dwSize","struVOOut","struVGAPara","struMatrixPara","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struVOOut","struVGAPara","struMatrixPara"})
    ...
    @Structure.FieldOrder({"sUserName","sPassword","byLocalRight","byRemoteRight","byNetPreviewRight","byLocalPlaybackRight","byNetPlaybackRight","byLocalRecordRight","byNetRecordRight","byLocalPTZRight","byNetPTZRight","byLocalBackupRight","struUserIP","byMACAddr","byPriority","byRes"})
    ...
    @Structure.FieldOrder({"sUserName","sPassword","dwLocalRight","dwLocalPlaybackRight","dwRemoteRight","dwNetPreviewRight","dwNetPlaybackRight","sUserIP","byMACAddr"})
    ...
    @Structure.FieldOrder({"sUserName","sPassword","dwLocalRight","dwRemoteRight","sUserIP","byMACAddr"})
    ...
    @Structure.FieldOrder({"dwSize","struUser"})
    ...
    @Structure.FieldOrder({"dwSize","struExceptionHandleType"})
    ...
    @Structure.FieldOrder({"byRecordStatic","bySignalStatic","byHardwareStatic","byRes1","dwBitRate","dwLinkNum","struClientIP","dwIPLinkNum","byExceedMaxLink","byRes","dwAllBitRate","dwChannelNo"})
    ...
    @Structure.FieldOrder({"byRecordStatic","bySignalStatic","byHardwareStatic","reservedData","dwBitRate","dwLinkNum","dwClientIP"})
    ...
    @Structure.FieldOrder({"dwVolume","dwFreeSpace","dwHardDiskStatic"})
    ...
    @Structure.FieldOrder({"dwDeviceStatic","struHardDiskStatic","struChanStatic","byAlarmInStatic","byAlarmOutStatic","dwLocalDisplay","byAudioChanStatus","byRes"})
    ...
    @Structure.FieldOrder({"dwDeviceStatic","struHardDiskStatic","struChanStatic","byAlarmInStatic","byAlarmOutStatic","dwLocalDisplay"})
    ...
    @Structure.FieldOrder({"strLogTime","dwMajorType","dwMinorType","sPanelUser","sNetUser","struRemoteHostAddr","dwParaType","dwChannel","dwDiskNumber","dwAlarmInPort","dwAlarmOutPort","dwInfoLen","sInfo"})
    ...
    //日志信息
    @Structure.FieldOrder({"strLogTime","dwMajorType","dwMinorType","sPanelUser","sNetUser","sRemoteHostAddr","dwParaType","dwChannel","dwDiskNumber","dwAlarmInPort","dwAlarmOutPort"})
    ...
    @Structure.FieldOrder({"m_Year","m_Month","m_Day","m_Hour","m_Minute","m_Second","DeviceName","dwChannelNumer","CardNumber","cTradeType","dwCash"})
    ...
    @Structure.FieldOrder({"dwSize","struATMIP","dwATMType","dwInputMode","dwFrameSignBeginPos","dwFrameSignLength","byFrameSignContent","dwCardLengthInfoBeginPos","dwCardLengthInfoLength","dwCardNumberInfoBeginPos","dwCardNumberInfoLength","dwBusinessTypeBeginPos","dwBusinessTypeLength","frameTypeCode","wATMPort","wProtocolType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sATMIP","dwATMType","dwInputMode","dwFrameSignBeginPos","dwFrameSignLength","byFrameSignContent","dwCardLengthInfoBeginPos","dwCardLengthInfoLength","dwCardNumberInfoBeginPos","dwCardNumberInfoLength","dwBusinessTypeBeginPos","dwBusinessTypeLength","frameTypeCode"})
    ...
    @Structure.FieldOrder({"sFtpType","sFtpCode"})
    ...
    @Structure.FieldOrder({"dwSize","sATMIP","dwATMType","dwInputMode","dwFrameSignBeginPos","dwFrameSignLength","byFrameSignContent","dwCardLengthInfoBeginPos","dwCardLengthInfoLength","dwCardNumberInfoBeginPos","dwCardNumberInfoLength","dwBusinessTypeBeginPos","dwBusinessTypeLength","frameTypeCode","sFTPIP","byFtpUsername","byFtpPasswd","sDirName","dwATMSrvType","dwTimeSpace","sFtpTypeCodeOp","dwADPlay","dwNewPort"})
...
/****************************ATM(end)***************************/
     ...
     ***************************/
//DS-6001D Decoder
    @Structure.FieldOrder({"byEncoderIP","byEncoderUser","byEncoderPasswd","bySendMode","byEncoderChannel","wEncoderPort","reservedData"})
    ...
    @Structure.FieldOrder({"byEncoderIP","byEncoderUser","byEncoderPasswd","byEncoderChannel","bySendMode","wEncoderPort","dwConnectState","reservedData"})
    ...
    @Structure.FieldOrder({"sDVRIP","wDVRPort","sUserName","sPassword","byChannel","byLinkMode","byLinkType"})
    ...
    @Structure.FieldOrder({"byPoolChans","struchanConInfo","byEnablePoll","byPoolTime"})
    ...
    @Structure.FieldOrder({"dwSize","dwDecChanNum","struDecInfo"})
    ...
    //2005-08-01
    @Structure.FieldOrder({"dwEnableTransPort","sDecoderIP","wDecoderPort","wDVRTransPort","cReserve"})
    ...
    @Structure.FieldOrder({"dwSize","struTransPortInfo"})
    ...
    @Structure.FieldOrder({"dwSize","sDecoderIP","wDecoderPort","wLoadMode","byFile","byFile","dwChannel","sUserName","sPassword","struStartTime","struStopTime"})
    ...
    @FieldOrder({"dwChannel","sUserName","sPassword","struStartTime","struStopTime"})
    ...
    @Structure.FieldOrder({"dwWorkType","sDVRIP","wDVRPort","byChannel","byLinkMode","dwLinkType","sUserName","sPassword","cReserve","sUserName","sPassword","cReserve","fileName","dwChannel","sUserName","sPassword","struStartTime","struStopTime"})
    ...
    @FieldOrder({"sUserName","sPassword","cReserve"})
    ...
    @Structure.FieldOrder({"dwSize","struDecState"})
     ...
     * DS-6001D/F(end)
     ***************************/
    @Structure.FieldOrder({"wShowString","wStringSize","wShowStringTopLeftX","wShowStringTopLeftY","sString"})
    ...
    //叠加字符(9000扩展)
    @Structure.FieldOrder({"dwSize","struStringInfo"})
...
EMAIL参数结构
*/
    @Structure.FieldOrder({"sName","sAddress"})
    ...
    @Structure.FieldOrder({"dwSize","sAccount","sPassword","struSender","sSmtpServer","sPop3Server","struReceiver","byAttachment","bySmtpServerVerify","byMailInterval","res"})
...
DVR实现巡航数据结构
*/
    @Structure.FieldOrder({"dwSize","byPresetNo","byCruiseSpeed","wDwellTime","byEnableThisCruise","res"})
...
//时间点
    @Structure.FieldOrder({"dwMonth","dwWeekNo","dwWeekDate","dwHour","dwMin"})
    ...
    //夏令时参数
    @Structure.FieldOrder({"dwSize","byRes1","dwEnableDST","byDSTBias","byRes2","struBeginPoint","struEndPoint"})
...
//辅助输出参数配置
    @Structure.FieldOrder({"dwSize","dwAlarmOutChan","dwAlarmChanSwitchTime","dwAuxSwitchTime","byAuxOrder"})
    ...
    //ntp
    @Structure.FieldOrder({"sNTPServer","wInterval","byEnableNTP","cTimeDifferenceH","cTimeDifferenceM","res1","wNtpPort","res2"})
    ...
    //ddns
    @Structure.FieldOrder({"sUsername","sPassword","sDomainName","byEnableDDNS","res"})
    ...
    @Structure.FieldOrder({"byHostIndex","byEnableDDNS","wDDNSPort","sUsername","sPassword","sDomainName","sServerName","byRes"})
    ...
    @Structure.FieldOrder({"sUsername","sPassword","sDomainName","sServerName","wDDNSPort","byRes"})
    ...
    //9000扩展
    @Structure.FieldOrder({"byEnableDDNS","byHostIndex","byRes1","struDDNS","byRes2"})
    ...
    //email
    @Structure.FieldOrder({"sUsername","sPassword","sSmtpServer","sPop3Server","sMailAddr","sEventMailAddr1","sEventMailAddr2","res"})
    ...
    @Structure.FieldOrder({"dwSize","sDNSIp","struNtpClientParam","struDDNSClientParam","res"})
    ...
    @Structure.FieldOrder({"sNfsHostIPAddr","sNfsDirectory"})
    ...
    @Structure.FieldOrder({"dwSize","struNfsDiskParam"})
    ...
    //巡航点配置(HIK IP快球专用)
    @Structure.FieldOrder({"PresetNum","Dwell","Speed","Reserve"})
    ...
    @Structure.FieldOrder({"struCruisePoint"})
...
//多路解码器扩展 added by zxy 2007-05-23
    @Structure.FieldOrder({"dwSize","sFirstDNSIP","sSecondDNSIP","sRes"})
    ...
    @Structure.FieldOrder({"sDVRIP","wDVRPort","byChannel","byTransProtocol","byTransMode","byRes","sUserName","sPassword"})
    ...
    @Structure.FieldOrder({"dwSize","struDecChanInfo"})
    ...
    @Structure.FieldOrder({"dwSize","dwIsLinked","dwStreamCpRate","cRes"})
...
//end 2007-12-13 modified by zxy
    @Structure.FieldOrder({"dwSize","struDecChanInfo","dwDecState","StartTime","StopTime","sFileName"})
    ...
    //连接的通道配置 2007-11-05
    @Structure.FieldOrder({"dwEnable","struDecChanInfo"})
    ...
    @Structure.FieldOrder({"dwSize","dwPoolTime","struchanConInfo"})
...
//矩阵行信息 2007-12-28
    @Structure.FieldOrder({"sSurvChanName","dwRowNum","struDecChanInfo"})
    ...
    @Structure.FieldOrder({"sSurvChanName","dwRowNum"})
    ...
    //矩阵列信息 2007-12-28
    @Structure.FieldOrder({"dwLocalDispChanNum","dwGlobalDispChanNum","dwRes"})
    ...
    @Structure.FieldOrder({"dwConflictTag","dwConflictGloDispChan","struColumnInfo"})
    ...
    //手动查看 2007-12-28
    @Structure.FieldOrder({"dwSize","dwRowNum","sSurvChanName","dwSurvNum","dwGlobalDispChanNum","dwLocalDispChanNum","dwTimeSel","StartTime","StopTime","sFileName"})
    ...
    @Structure.FieldOrder({"dwSize","dwGlobalDispChanNum","dwLocalDispChanNum"})
    ...
    @Structure.FieldOrder({"dwSize","dwLocalDispChanNum","dwGlobalDispChanNum","dwCycTimeInterval"})
    ...
    @Structure.FieldOrder({"dwSize","dwLocalHostProperty","dwIsIsolated","dwLocalMatrixHostPort","byLocalMatrixHostUsrName","byLocalMatrixHostPasswd","dwLocalMatrixCtrlMedia","sMatrixCenterIP","dwMatrixCenterPort","byMatrixCenterUsrName","byMatrixCenterPasswd"})
    ...
    //2007-12-22
    @Structure.FieldOrder({"baudrate","databits","stopbits","parity","flowcontrol","res"})
    ...
    @Structure.FieldOrder({"byTranChanEnable","byLocalSerialDevice","byRemoteSerialDevice","res1","sRemoteDevIP","wRemoteDevPort","res2","RemoteSerialDevCfg"})
    ...
    @Structure.FieldOrder({"dwSize","by232IsDualChan","by485IsDualChan","res","struTranInfo"})
    ...
    @Structure.FieldOrder({"dwSize","sDVRIP","wDVRPort","byChannel","byReserve","sUserName","sPassword","dwPlayMode","StartTime","StopTime","sFileName"})
    ...
    @Structure.FieldOrder({"dwSize","dwPlayCmd","dwCmdParam"})
    ...
    @Structure.FieldOrder({"dwSize","dwCurMediaFileLen","dwCurMediaFilePosition","dwCurMediaFileDuration","dwCurPlayTime","dwCurMediaFIleFrames","dwCurDataType","res"})
    ...
    @Structure.FieldOrder({"wTransProtol","wPassivePort","struMcastIP","byStreamType","res"})
...
/************************************多路解码器(end)***************************************/
    ...
    @Structure.FieldOrder({"dwSize","dwWindowNo","dwSceneNo","dwDestWallNo","dwDestSceneNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struVideoWallInfo","dwCmd","byRes"})
    ...
    @Structure.FieldOrder({"pBuf","nLen"})

    public static class NET_DVR_BUF_INFO extends Structure {
        public Pointer pBuf;
        public int nLen;
    }
    @Structure.FieldOrder({"struCondBuf","struInParamBuf","dwRecvTimeout","byRes"})
    ...
    @Structure.FieldOrder({"struOutBuf","lpStatusList","byRes"})
    ...
    @Structure.FieldOrder({"dwXCoordinate","dwYCoordinate","dwWidth","dwHeight","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byWndOperateMode","byRes1","dwWindowNo","dwLayerIndex","struRect","struResolution","dwXCoordinate","dwYCoordinate","byRes2"})
    ...
    @Structure.FieldOrder({"strVideoWinPostion"})
    ...
    @Structure.FieldOrder({"dwSize","byTransparency","byWinMode","byEnableSpartan","byDecResource","byWndShowMode","byEnabledFeature","byFeatureMode","byRes1","dwAmplifyingSubWndNo","byWndTopKeep","byWndOpenKeep","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwPlanNums","pBuffer","byWallNo","byRes1","dwBufLen","byRes2"})
    ...
    /*预案项信息*/
    @Structure.FieldOrder({"byValid","byType","wLayoutNo","byScreenStyle","byBaseMapType","byRes1","dwDelayTime","dwSerialNo","dwBaseMapWndNo","dwBaseMapNo","byRes2"})
    ...
    @Structure.FieldOrder({"byValid","byRes","struTime"})
    ...
    /*预案管理*/
    @Structure.FieldOrder({"dwSize","byValid","byWorkMode","byWallNo","byPlanNo","byPlanName","struTime","struTimeCycle","dwWorkCount","strPlanEntry","dwPlanNo","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","sSceneName","byEnable","bySceneIndex","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwSubWndNo","dwOSDNums","struOSDList","byRes"})
    ...
    @Structure.FieldOrder({"byEnabled","byEnabledFlash","byFontSize","byTransparent","struColor","wCoordinateX","wCoordinateY","byContent","byRes"})
    ...
    @Structure.FieldOrder({"byChanType","byStreamId","byRes1","dwChannel","byRes2","byAddress","wDVRPort","byChannel","byTransProtocol","byTransMode","byFactoryType","byDeviceType","byDispChan","bySubDispChan","byResolution","byRes","sUserName","sPassword"})
    ...
    @Structure.FieldOrder({"byValid","byRes1","byAddress","wDevPort","byTransmitType","byRes2"})
    ...
    @Structure.FieldOrder({"byDevAddress","byTransProtocol","byTransMode","byDdnsType","byRes1","byDdnsAddress","wDdnsPort","byChanType","byFactoryType","dwChannel","byStreamId","sUserName","sPassword","wDevPort","byRes2"})
    ...
    @Structure.FieldOrder({"struStreamMediaSvrCfg","struDevChanInfo"})
    ...
    //DDNS方式取流
    @Structure.FieldOrder({"struDdnsInfo","struMediaServer"})
    ...
    @Structure.FieldOrder({"byEnable","byStreamMode","byRes","uDecStreamMode"})
    ...
    @Structure.FieldOrder({"dwSize","dwPoolTime","struchanConInfo","byStreamEncrypt","byRes","sStreamPassword"})
     ...
     * 拼控(End)
     ***************************************/
    @Structure.FieldOrder({"dwSize","sUserName","sPassWord","sFromName","sFromAddr","sToName1","sToName2","sToAddr1","sToAddr2","sEmailServer","byServerType","byUseAuthen","byAttachment","byMailinterval"})
    ...
    @Structure.FieldOrder({"dwSize","struLowCompression","struEventCompression"})
    ...
    //球机位置信息
    @Structure.FieldOrder({"wAction","wPanPos","wTiltPos","wZoomPos"})
    ...
    //球机范围信息
    @Structure.FieldOrder({"wPanPosMin","wPanPosMax","wTiltPosMin","wTiltPosMax","wZoomPosMin","wZoomPosMax"})
    ...
    @Structure.FieldOrder({"dwSize","struPTZCtrl","dwFocalLen","fHorizontalSpeed","fVerticalSpeed","byZoomType","byRes"})
    ...
    //rtsp配置 ipcamera专用
    @Structure.FieldOrder({"dwSize","wPort","byReserve"})
...
//NET_DVR_Login()参数结构
    @Structure.FieldOrder({"sSerialNumber","byAlarmInPortNum","byAlarmOutPortNum","byDiskNum","byDVRType","byChanNum","byStartChan"})
    ...
    @Structure.FieldOrder({"sDeviceAddress","byUseTransport","wPort","sUserName","sPassword","cbLoginResult","pUser","bUseAsynLogin","byProxyType","byUseUTCTime","byLoginMode","byHttps","iProxyID","byVerifyMode","byRes2"})
    ...
    //软解码预览参数
    @Structure.FieldOrder({"lChannel","lLinkMode","hPlayWnd","sMultiCastIP"})
    ...
    //预览V40接口
    @Structure.FieldOrder({"lChannel","dwStreamType","dwLinkMode","hPlayWnd","bBlocked","bPassbackRecord","byPreviewMode","byStreamID","byProtoType","byRes1","byVideoCodingType","dwDisplayBufNum","byNPQMode","byRes"})
    ...
    //配置条件
    @Structure.FieldOrder({"dwSize","dwChannel","byRes1"})
    public static class NET_DVR_CLOUDSTORAGE_COND extends Structure {
        public int dwSize;
        public int dwChannel;
        public byte[] byRes1 = new byte[64];
    }
    @Structure.FieldOrder({"dwSize","byRecord","byOffLineRecord","byRes1","dwRelatedHD","byRes2"})
    ...
    //SDK状态信息(9000新增)
    @Structure.FieldOrder({"dwTotalLoginNum","dwTotalRealPlayNum","dwTotalPlayBackNum","dwTotalAlarmChanNum","dwTotalFormatNum","dwTotalFileSearchNum","dwTotalLogSearchNum","dwTotalSerialNum","dwTotalUpgradeNum","dwTotalVoiceComNum","dwTotalBroadCastNum","dwRes"})
    ...
    //SDK功能支持信息(9000新增)
    @Structure.FieldOrder({"dwMaxLoginNum","dwMaxRealPlayNum","dwMaxPlayBackNum","dwMaxAlarmChanNum","dwMaxFormatNum","dwMaxFileSearchNum","dwMaxLogSearchNum","dwMaxSerialNum","dwMaxUpgradeNum","dwMaxVoiceComNum","dwMaxBroadCastNum","dwRes"})
    ...
    //报警设备信息
    @Structure.FieldOrder({"byUserIDValid","bySerialValid","byVersionValid","byDeviceNameValid","byMacAddrValid","byLinkPortValid","byDeviceIPValid","bySocketIPValid","lUserID","sSerialNumber","dwDeviceVersion","sDeviceName","byMacAddr","wLinkPort","sDeviceIP","sSocketIP","byIpProtocol","byRes2"})
    ...
    //硬解码显示区域参数(子结构)
    @Structure.FieldOrder({"bToScreen","bToVideoOut","nLeft","nTop","nWidth","nHeight","nReserved"})
    ...
    //硬解码预览参数
    @Structure.FieldOrder({"lChannel","lLinkMode","sMultiCastIP","struDisplayPara"})
    ...
    //录象文件参数
    @Structure.FieldOrder({"sFileName","struStartTime","struStopTime","dwFileSize"})
    ...
    //录象文件参数(9000)
    @Structure.FieldOrder({"sFileName","struStartTime","struStopTime","dwFileSize","sCardNum","byLocked","byRes"})
    ...
    //录象文件参数(带卡号)
    @Structure.FieldOrder({"sFileName","struStartTime","struStopTime","dwFileSize","sCardNum"})
    ...
    @Structure.FieldOrder({"lChannel","dwFileType","dwIsLocked","dwUseCardNo","sCardNumber","struStartTime","struStopTime","byDrawFrame","byFindType","byQuickSearch","bySpecialFindInfoType","dwVolumeNum","byWorkingDeviceGUID","uSpecialFindInfo","byStreamType","byAudioFile","byRes2"})
    ...
    @Structure.FieldOrder({"byTransactionType","byRes","dwTransationAmount"})
    ...
    //录像文件查找条件结构V50
    @Structure.FieldOrder({"struStreamID","struStartTime","struStopTime","byFindType","byDrawFrame","byQuickSearch","byStreamType","dwFileType","dwVolumeNum","byIsLocked","byNeedCard","byOnlyAudioFile","bySpecialFindInfoType","szCardNum","szWorkingDeviceGUID","uSpecialFindInfo","dwTimeout","byRes"})
    ...
    @Structure.FieldOrder({"sFileName","struStartTime","struStopTime","dwFileSize","sCardNum","byLocked","byFileType","byQuickSearch","byRes","dwFileIndex","byStreamType","byRes1"})
    ...
    @Structure.FieldOrder({"wYear","byMonth","byDay","byHour","byMinute","bySecond","cTimeDifferenceH","cTimeDifferenceM","byLocalOrUTC","wMillisecond"})
    ...
    @Structure.FieldOrder({"sFileName","struStartTime","struStopTime","struAddr","dwFileSize","byLocked","byFileType","byQuickSearch","byStreamType","dwFileIndex","sCardNum","dwTotalLenH","dwTotalLenL","byBigFileType","byRes"})
    ...
    @Structure.FieldOrder({"lChannel", "dwFileType", "dwIsLocked", "dwUseCardNo", "sCardNumber", "struStartTime", "struStopTime"})
    ...
    @Structure.FieldOrder({"dwChannel", "struStartTime", "struStopTime", "byDrawFrame", "byStreamType", "byStreamID", "byRes"})
    ...
    @Structure.FieldOrder({"dwSize", "struIDInfo", "struBeginTime", "struEndTime", "hWnd", "byDrawFrame", "byVolumeType", "byVolumeNum", "byStreamType", "dwFileIndex", "byAudioFile", "byCourseFile", "byDownload", "byOptimalStreamType", "byRes2"})
    ...
    //图片查找条件
    @Structure.FieldOrder({"dwSize","lChannel","byFileType","byNeedCard","byProvince","byEventType","sCardNum","struStartTime","struStopTime","dwTrafficType","dwVehicleType","dwIllegalType","byLaneNo","bySubHvtType","byRes2","sLicense","byRegion","byCountry","byArea","byISO8601","cStartTimeDifferenceH","cStartTimeDifferenceM","cStopTimeDifferenceH","cStopTimeDifferenceM"})
    ...
    @Structure.FieldOrder({"sFileName","struTime","dwFileSize","sCardNum","byPlateColor","byVehicleLogo","byEventSearchStatus","byRecogResult","sLicense","byRes"})
    ...
    @Structure.FieldOrder({"sFileName", "struTime", "dwFileSize", "sCardNum", "byPlateColor", "byVehicleLogo", "byFileType", "byRecogResult", "sLicense", "byEventSearchStatus", "struAddr", "byRes", "uPicExtraInfo"})
    public static class NET_DVR_FIND_PICTURE_V50 extends Structure {
        public byte[] sFileName = new byte[PICTURE_NAME_LEN];//图片名
    ...
    @Structure.FieldOrder({"pDVRFileName", "pSavedFileBuf", "dwBufLen", "lpdwRetLen", "struAddr", "byRes"})
    ...
    //查找结果结构体
    @Structure.FieldOrder({"sFileName","struTime","dwFileSize","sCardNum","byPlateColor","byVehicleLogo","byFileType","byRecogResult","sLicense","byEventSearchStatus","byRes","uPicExtraInfo"})
    ...
    @Structure.FieldOrder({"wWidth","wHeight","dwTimeStamp","dwTimeStampHigh","dwYear","dwMonth","dwDay","dwHour","dwMinute","dwSecond","dwMillisecond","dwFrameNum","dwFrameRate","dwFlag","dwFilePos","dwPacketType","dwPacketSize","pPacketBuffer","byRes1","dwPacketMode","byRes2","dwReserved"})
    ...
    //云台区域选择放大缩小(HIK 快球专用)
    @Structure.FieldOrder({"xTop","yTop","xBottom","yBottom","bCounter"})
    ...
    //语音对讲参数
    @Structure.FieldOrder({"byAudioEncType","byAudioSamplingRate","byAudioBitRate","byres","bySupport"})
    ...
    @Structure.FieldOrder({"nchans","sample_rate","aacdec_profile","reserved"})
    ...
    //音频解码
    @Structure.FieldOrder({"in_buf","out_buf","in_data_size","proc_data_size","out_frame_size","dec_info","g726dec_reset","g711_type","reserved"})
    ...
    @Structure.FieldOrder({"in_frame_size","reserved"})
    ...
    //音频编码
    @Structure.FieldOrder({"in_buf","out_buf","out_frame_size","g726enc_reset","g711_type","enc_mode","reserved"})
    ...
    //用于接收报警信息的缓存区
    @Structure.FieldOrder({"RecvBuffer"})
    public static class RECV_ALARM extends Structure {
        public byte[] RecvBuffer = new byte[4000];//此处的400应不小于最大报警报文长度
    }

    //布防参数
    @Structure.FieldOrder({"dwSize","byLevel","byAlarmInfoType","byRetAlarmTypeV40","byRetDevInfoVersion","byRetVQDAlarmType","byFaceAlarmDetection","bySupport","byBrokenNetHttp","wTaskNo","byDeployType","byRes1","byAlarmTypeURL","byCustomCtrl"})
    ...
    @Structure.FieldOrder({"dwSize","byLevel","byAlarmInfoType","byRetAlarmTypeV40","byRetDevInfoVersion","byRetVQDAlarmType","byFaceAlarmDetection","bySupport","byBrokenNetHttp","wTaskNo","byDeployType","bySubScription","byRes1","byAlarmTypeURL","byCustomCtrl","byRes4"})
    ...
    //区域框参数
    @Structure.FieldOrder({"fX","fY","fWidth","fHeight"})
    ...
    //报警目标信息
    @Structure.FieldOrder({"dwID","struRect","byRes"})
    ...
    //前端设备信息
    @Structure.FieldOrder({"struDevIP","wPort","byChannel","byIvmsChannel"})
    ...
    //事件规则信息
    @Structure.FieldOrder({"byRuleID","byRes","wEventTypeEx","byRuleName","dwEventType","uEventParam"})
    ...
    //穿越警戒面参数
    @Structure.FieldOrder({"struPlaneBottom","dwCrossDirection","bySensitivity","byPlaneHeight","byDetectionTarget","byRes2"})
...
//入侵参数
    @Structure.FieldOrder({"struRegion","wDuration","bySensitivity","byRate","byDetectionTarget","byPriority","byAlarmConfidence","byRecordConfidence"})
    ...
    */
    ...
    @Structure.FieldOrder({"struRegion","wLeaveDelay","wStaticDelay","byMode","byPersonType","byOnPosition","bySensitivity"})
    ...
    @Structure.FieldOrder({"dwHandleType","dwMaxRelAlarmOutChanNum","dwRelAlarmOutChanNum","dwRelAlarmOut","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byEnableDualVca","byRes1","struAlertParam","struAlarmSched","struHandleException","dwMaxRelRecordChanNum","dwRelRecordChanNum","byRelRecordChan","struHolidayTime","byRes2"})
    ...
    //快速移动参数
    @Structure.FieldOrder({"struRegion","fRunDistance","bySensitivity","byMode","byDetectionTarget","byRes"})
    ...
    */
    ...
    //奔跑检测
    @Structure.FieldOrder({"struRegion","dwSpeed","wDuration","byRunMode","byRes"})
    ...
    //倒地参数
    @Structure.FieldOrder({"struRegion","wDuration","bySensitivity","byHeightThreshold","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byEnableDualVca","byEnableHumanMisinfoFilter","byEnableVehicleMisinfoFilter","struIntrusion","struAlarmSched","struHandleException","dwMaxRelRecordChanNum","dwRelRecordChanNum","byRelRecordChan","struHolidayTime","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","dwGroup","byID","byRes1","dwPositionNo","byRes"})
    ...
    //线结构参数
    @Structure.FieldOrder({"struStart","struEnd"})
    ...
    //进入/离开区域参数
    @Structure.FieldOrder({"struRegion","bySensitivity","byDetectionTarget","byPriority","byRes"})
    ...
    //多边形结构体
    @Structure.FieldOrder({"dwPointNum","struPos"})
    ...
    @Structure.FieldOrder({"byActive","byMode","byRes","struMiniRect","struMaxRect"})
    ...
    //尺寸过滤策略
    @Structure.FieldOrder({"byStrategy","byRes"})
    ...
    //异常行为检测报警
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","struRuleInfo","struTargetInfo","struDevInfo","dwPicDataLen","byPicType","byRelAlarmPicNum","bySmart","byPicTransType","dwAlarmID","wDevInfoIvmsChannelEx","byRelativeTimeFlag","byAppendInfoUploadEnabled","pAppendInfo","pImage"})
    ...
    @Structure.FieldOrder({"wYear","wMonth","wDay","wHour","wMinute","wSecond","wMilliSec","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","struTime","szTaskID","dwAIOPDataSize","dwPictureSize","szMPID","pBufferAIOPData","pBufferPicture","byPictureMode","byRes2","dwPresetIndex","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struTime","szPID","dwAIOPDataSize","byStatus","byRes1","szMPID","pBufferAIOPData","dwPresetIndex","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","szTaskID","szPID","byRes"})
    ...
    //规则触发参数
    @Structure.FieldOrder({"byTriggerMode","byTriggerPoint","byRes1","fTriggerArea","byRes2"})
    ...
    @Structure.FieldOrder({"byActive","byEventPriority","byRes1","wEventType","byRuleName","uEventParam","struSizeFilter","struAlarmTime","struAlarmHandleType","dwRelRecordChan","wAlarmDelay","byRes2","struFilterStrategy","struTriggerParam","byRes"})
    ...
    @Structure.FieldOrder({"byEnable","byRes1","byPtzPositionName","struPtzPos","byRes2"})
    ...
    //异常行为检测配置结构体
    @Structure.FieldOrder({"dwSize","byPicProType","byUpLastAlarm","byPicRecordEnable","byRes1","struPicParam","struRule","wRelSnapChan","byTrackEnable","byRes2","struPTZPosition","wTrackDuration","wIntervalTime","wHeightLimit","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sCIDCode","sCIDDescribe","struTriggerTime","struUploadTime","sCenterAccount","byReportType","byUserType","sUserName","wKeyUserNo","byKeypadNo","bySubSysNo","wDefenceNo","byVideoChanNo","byDiskNo","wModuleAddr","byCenterType","byRes1","sCenterAccountV40","byDevSerialNo","byRepeaterNo","wRemoteCtrllerUserNo","dwIOTChannelNo","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwAbsTime","byName","bySensorChannel","byType","byAlarmType","byAlarmMode","fValue","fOriginalValue","byRes2"})
    ...
    //开关量报警上传
    @Structure.FieldOrder({"dwSize","byName","wSwitchChannel","byAlarmType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwExceptionType","byRes"})
    ...
    @Structure.FieldOrder({"byChanType","byPointType","byRes1","dwChanNo","dwSubChanNo","dwVariableNo","dwPointNo","iValue","iValueEx","byRes"})
    ...
    @Structure.FieldOrder({"byLength","struPointValue"})
    ...
    @Structure.FieldOrder({"dwSize","byDataType","byRes1","struAlarmData","byRes2"})
    ...
    //车牌识别结果子结构
    @Structure.FieldOrder({"byPlateType","byColor","byBright","byLicenseLen","byEntireBelieve","byRegion","byCountry","byArea","byPlateSize","byAddInfoFlag","wCRIndex","byRes","sPlateCategory","dwXmlLen","pXmlBuf","struPlateRect","sLicense","byBelieve"})
    ...
    @Structure.FieldOrder({"dwIndex","byVehicleType","byColorDepth","byColor","byRadarState","wSpeed","wLength","byIllegalType","byVehicleLogoRecog","byVehicleSubLogoRecog","byVehicleModel","byCustomInfo","wVehicleLogoRecog","byIsParking","byRes","dwParkingTime","byRes3"})
    ...
    */
    ...
    //手动抓拍
    @Structure.FieldOrder({"byOSDEnable","byLaneNo","byChannel","byRes"})
    ...
    //交通抓拍结果信息
    @Structure.FieldOrder({"dwSize","byResultType","byChanIndex","wAlarmRecordID","dwRelativeTime","byAbsTime","dwPicLen","dwPicPlateLen","dwVideoLen","byTrafficLight","byPicNum","byDriveChan","byVehicleType","dwBinPicLen","dwCarPicLen","dwFarCarPicLen","pBuffer3","pBuffer4","pBuffer5","byRes3","struPlateInfo","struVehicleInfo","pBuffer1","pBuffer2"})
    ...
    @Structure.FieldOrder({"dwDataLen","byType","byDataType","byCloseUpType","byPicRecogMode","dwRedLightTime","byAbsTime","struPlateRect","struPlateRecgRect","pBuffer","dwUTCTime","byCompatibleAblity","byTimeDiffFlag","cTimeDifferenceH","cTimeDifferenceM","byRes2"})
    ...
    //停车场数据上传
    @Structure.FieldOrder({"dwSize","byGroupNum","byPicNo","byLocationNum","byParkError","byParkingNo","byLocationStatus","bylogicalLaneNum","wUpLoadType","byRes1","dwChanIndex","struPlateInfo","struVehicleInfo","byMonitoringSiteID","byDeviceID","dwPicNum","struPicInfo","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","byRelatedDriveWay","bySnapTimes","wSnapWaitTime","wIntervalTime","dwSnapVehicleNum","struJpegPara","byRes2"})
    ...
    // 道闸控制
    @Structure.FieldOrder({"dwSize","dwChannel","byLaneNo","byBarrierGateCtrl","byEntranceNo","byUnlock","byRes"})
    ...
    */
    ...
    @Structure.FieldOrder({"dwTeenage","dwYouth","dwMidLife","dwElderly","dwChild","dwAdolescent","dwPrime","dwMidage","byRes"})
    ...
    @Structure.FieldOrder({"dwMale","dwFemale","byRes"})
    ...
    @Structure.FieldOrder({"dwProgramNo","sProgramName","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struStartTime","struEndTime","byStatType","byRes","dwPeopleNum","byRes2","struSexGroupParam","struProgramInfo","byRes1"})
    ...
    //获取交通数据条件结构
    @Structure.FieldOrder({"dwSize","dwQueryCond","dwChannel","struStartTime","struEndTime","sLicense","dwPlateType","dwPlateColor","dwVehicleColor","dwVehicleType","dwIllegalType","dwEventType","dwForensiceType","wVehicleLogoRecog","byLaneNo","byDirection","wMinSpeed","wMaxSpeed","byDataType","byExecuteCtrl","byRes"})
    ...
    //交通数据结构体
    @Structure.FieldOrder({"dwSize","dwChannel","sLicense","dwPlateType","dwPlateColor","dwVehicleColor","dwVehicleType","dwIllegalType","dwEventType","dwForensiceType","wVehicleLogoRecog","byLaneNo","byDirection","wSpeed","byDataType","byRes","struTrafficPic"})
    ...
    */
    ...
    @Structure.FieldOrder({"dwChannel","dwOperateType","sLicense","sCardNo","byListType","byRes1","dwDataIndex","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","dwDataIndex","sLicense","byListType","byPlateType","byPlateColor","byRes","sCardNo","struStartTime","struStopTime","sOperateIndex","byRes1"})
    ...
    //车辆报警
    @Structure.FieldOrder({"dwSize","byListType","byPlateType","byPlateColor","byRes1","sLicense","sCardNo","struAlarmTime","dwChannel","dwPicDataLen","byPicType","byPicTransType","byRes3","pPicData","byRes2"})
    ...
    //LED屏幕显示参数
    @Structure.FieldOrder({"dwSize","sDisplayInfo","byDisplayMode","bySpeedType","byShowPlateEnable","byRes1","dwShowTime","byRes"})
    ...
    //语音播报控制参数
    @Structure.FieldOrder({"dwSize","sInfo","byBroadcastNum","byIntervalTime","byRes"})
    ...
    //缴费金额信息
    @Structure.FieldOrder({"dwSize","fAccount","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwTemplateNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwEventID","wLocalControllerID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byProMode","byRes1","dwEventSourceID","uLinkageInfo","byAlarmout","byRes2","byOpenDoor","byCloseDoor","byNormalOpen","byNormalClose","byMainDevBuzzer","byCapturePic","byRecordVideo","byRes3","byReaderBuzzer","byAlarmOutClose","byAlarmInSetup","byAlarmInClose","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byProMode","byRes1","dwEventSourceID","uLinkageInfo","byAlarmout","byRes2","byOpenDoor","byCloseDoor","byNormalOpen","byNormalClose","byMainDevBuzzer","byCapturePic","byRecordVideo","byMainDevStopBuzzer","wAudioDisplayID","byAudioDisplayMode","byRes3","byReaderBuzzer","byAlarmOutClose","byAlarmInSetup","byAlarmInClose","byReaderStopBuzzer","byRes"})
    ...
    //卡参数配置条件
    @Structure.FieldOrder({"dwSize","dwCardNum","byCheckCardNo","ibyRes"})
    ...
    //卡参数
    @Structure.FieldOrder({"dwSize","dwModifyParamType","byCardNo","byCardValid","byCardType","byLeaderCard","byRes1","dwDoorRight","struValid","dwBelongGroup","byCardPassword","byCardRightPlan","dwMaxSwipeTime","dwSwipeTime","wRoomNumber","wFloorNumber","byRes2"})
    ...
    //有效期参数结构体
    @Structure.FieldOrder({"byEnable","byBeginTimeFlag","byEnableTimeFlag","byTimeDurationNo","struBeginTime","struEndTime","byTimeType","byRes2"})
    ...
    //扩展结构体信息
    @Structure.FieldOrder({"byRemoteCheck","byThermometryUnit","byIsAbnomalTemperature","byRes2","fCurrTemperature","struRegionCoordinates","dwQRCodeInfoLen","dwVisibleLightDataLen","dwThermalDataLen","pQRCodeInfo","pVisibleLightData","pThermalData","byRes"})
    ...
    //身份证信息报警
    @Structure.FieldOrder({"dwSize","struIDCardCfg","dwMajor","dwMinor","struSwipeTime","byNetUser","struRemoteHostAddr","dwCardReaderNo","dwDoorNo","dwPicDataLen","pPicData","byCardType","byDeviceNo","byMask","byCurrentEvent","dwFingerPrintDataLen","pFingerPrintData","dwCapturePicDataLen","pCapturePicData","dwCertificatePicDataLen","pCertificatePicData","byCardReaderKind","byRes3","byIDCardInfoExtend","pIDCardInfoExtend","dwSerialNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwCardNum","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byCardType","byLeaderCard","byUserType","byRes1","byDoorRight","struValid","byBelongGroup","byCardPassword","wCardRightPlan","dwMaxSwipeTimes","dwSwipeTimes","dwEmployeeNo","byName","dwCardRight","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwErrorCode","byStatus","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwFaceNum","dwEnableReaderNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwFaceLen","pFaceBuffer","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byErrorMsg","dwReaderNo","byRecvStatus","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwFingerprintNum","byCardNo","dwEnableReaderNo","byFingerPrintID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwFingerPrintLen","dwEnableReaderNo","byFingerPrintID","byFingerType","byRes1","byFingerData","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byCardReaderRecvStatus","byFingerPrintID","byFingerType","byRecvStatus","byErrorMsg","dwCardReaderNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byFingerPrintPicType","byFingerNo","byRes"})
    ...
    //
    @Structure.FieldOrder({"dwSize","dwFingerPrintDataSize","byFingerData","dwFingerPrintPicSize","pFingerPrintPicBuffer","byFingerNo","byFingerPrintQuality","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byMode","byRes1","struProcessMode","byRes"})
    ...
    @Structure.FieldOrder({"dwCardReaderNo","byClearAllCard","byRes1","byCardNo","byEmployeeNo","byRes"})
    ...
    @Structure.FieldOrder({"byCardNo","byEnableCardReader","byFingerPrintID","byRes1","byEmployeeNo"})
    ...
    @Structure.FieldOrder({"byCardNo","byEnableCardReader","byFaceID","byRes1"})
    ...
    @Structure.FieldOrder({"dwCardReaderNo","byClearAllCard","byRes1","byCardNo","byRes"})
    ...
    //门禁主机参数
    @Structure.FieldOrder({"dwSize","byRS485Backup","byShowCapPic","byShowCardNo","byShowUserInfo","byOverlayUserInfo","byVoicePrompt","byUploadCapPic","bySaveCapPic","byInputCardNo","byEnableWifiDetect","byEnable3G4G","byProtocol","byRes"})
     ...
     * 优化接口结构体定义结束
     ***************************/
    @Structure.FieldOrder({"dwSize","dwBlockListNum","byRes"})
    public static class NET_DVR_UPLOAD_ID_BLOCKLIST_COND extends Structure {
        public int dwSize;
        public int dwBlockListNum; //禁止名单数量
        public byte[] byRes = new byte[128];
    }
    @Structure.FieldOrder({"dwSize","struIDCardCfg","byBlockListValid","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byIDNum","byStatus","byRes"})
    ...
    @Structure.FieldOrder({"byStatus","byErrorCode"})
    ...
    //开锁记录
    @Structure.FieldOrder({"byUnlockType","byRes1","byControlSrc","dwPicDataLen","pImage","dwCardUserID","nFloorNumber","wRoomNumber","wLockID","byRes2","byLockName","byEmployeeNo","byRes"})
    ...
    //公告信息阅读回执
    @Structure.FieldOrder({"byNoticeNumber","byRes"})
    ...
    //认证记录（设备未实现）
    @Structure.FieldOrder({"byAuthResult","byAuthType","byRes1","byCardNo","dwPicDataLen","pImage","byRes"})
    ...
    //车牌信息上传
    @Structure.FieldOrder({"sLicense","byColor","byRes"})
    ...
    @Structure.FieldOrder({"byCardNo","byRes"})
    ...
    //防区报警信息结构体
    @Structure.FieldOrder({"byZoneName","dwZonendex","byZoneType","byRes"})
    ...
    //可视对讲报警信息结构体
    @Structure.FieldOrder({"dwSize","struTime","byDevNumber","byAlarmType","byRes1","uAlarmInfo","wLockID","byRes2"})
    ...
    //可视对讲事件记录
    @Structure.FieldOrder({"dwSize","struTime","byDevNumber","byEventType","byPicTransType","byRes1","uEventInfo","dwIOTChannelNo","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwCmdType","wPeriod","wBuildingNumber","wUnitNumber","wFloorNumber","wRoomNumber","wDevIndex","byUnitType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwGatewayIndex","byCommand","byLockType","wLockID","byControlSrc","byControlType","byRes3","byPassword","byRes2"})
    ...
    //公告图片信息结构体
    @Structure.FieldOrder({"pPicData","dwPicDataLen","byRes"})
    ...
    //公告数据
    @Structure.FieldOrder({"dwSize","struTime","byNoticeNumber","byNoticeTheme","byNoticeDetail","byLevel","byPicNum","byRes1","struNoticePic","byRes2"})
    ...
    @Structure.FieldOrder({"wYear","byMonth","byDay"})
    ...
    //身份证信息
    @Structure.FieldOrder({"dwSize","byName","struBirth","byAddr","byIDNum","byIssuingAuthority","struStartDate","struEndDate","byTermOfValidity","bySex","byNation","byRes"})
    ...
    //门禁主机报警信息结构体
    @Structure.FieldOrder({"dwSize","dwMajor","dwMinor","struTime","sNetUser","struRemoteHostAddr","struAcsEventInfo","dwPicDataLen","pPicData","wInductiveEventType","byPicTransType","byRes1","dwIOTChannelNo","pAcsEventInfoExtend","byAcsEventInfoExtend","byTimeType","byRes2","byAcsEventInfoExtendV20","pAcsEventInfoExtendV20","byRes"})
    ...
    @Structure.FieldOrder({"dwFrontSerialNo","byUserType","byCurrentVerifyMode","byCurrentEvent","byPurePwdVerifyEnable","byEmployeeNo","byAttendanceStatus","byStatusValue","byRes2","byUUID","byDeviceName","byRes"})
    ...
    门禁主机报警事件细节结构体
     */
    @Structure.FieldOrder({"dwSize","byCardNo","byCardType","byAllowListNo","byReportChannel","byCardReaderKind","dwCardReaderNo","dwDoorNo","dwVerifyNo","dwAlarmInNo","dwAlarmOutNo","dwCaseSensorNo","dwRs485No","dwMultiCardGroupNo","wAccessChannel","byDeviceNo","byDistractControlNo","dwEmployeeNo","wLocalControllerID","byInternetAccess","byType","byMACAddr","bySwipeCardType","byEventAttribute","dwSerialNo","byChannelControllerID","byChannelControllerLampID","byChannelControllerIRAdaptorID","byChannelControllerIREmitterID","dwRecordChannelNum","pRecordChannelData","byUserType","byCurrentVerifyMode","byAttendanceStatus","byStatusValue","byEmployeeNo","byRes1","byMask","byThermometryUnit","byIsAbnomalTemperature","fCurrTemperature","struRegionCoordinates","byRes"})
    ...
    门禁主机报警事件配置结构体
     */
    @Structure.FieldOrder({"dwSize","dwMajor","dwMinor","struTime","sNetUser","struRemoteHostAddr","struAcsEventInfo","dwPicDataLen","pPicData","wInductiveEventType","byTimeType","byRes1","dwQRCodeInfoLen","dwVisibleLightDataLen","dwThermalDataLen","pQRCodeInfo","pVisibleLightData","pThermalData","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwMajor","dwMinor","struStartTime","struEndTime","byCardNo","byName","byPicEnable","byTimeType","byRes2","dwBeginSerialNo","dwEndSerialNo","dwIOTChannelNo","wInductiveEventType","bySearchType","byEventAttribute","szMonitorID","byEmployeeNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byDoorLockStatus","byDoorStatus","byMagneticStatus","byCaseStatus","wBatteryVoltage","byBatteryLowVoltage","byPowerSupplyStatus","byMultiDoorInterlockStatus","byAntiSneakStatus","byHostAntiDismantleStatus","byIndicatorLightStatus","byCardReaderOnlineStatus","byCardReaderAntiDismantleStatus","byCardReaderVerifyMode","bySetupAlarmStatus","byAlarmInStatus","byAlarmOutStatus","dwCardNum","byFireAlarmStatus","byBatteryChargeStatus","byMasterChannelControllerStatus","bySlaveChannelControllerStatus","byAntiSneakServerStatus","byRes3","dwAllowFaceNum","dwBlockFaceNum","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwParamType","wLocalControllerID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byEnableCardReader","dwFaceNum","byFaceID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwFaceLen","pFaceBuffer","byEnableCardReader","byFaceID","byFaceDataType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byCardReaderRecvStatus","byErrorMsg","dwCardReaderNo","byTotalStatus","byFaceID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwPictureNum","byCheckTemplate","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwPictureNo","dwPictureLen","pPictureBuffer","dwFaceTemplateLen","pFaceTemplateBuffer","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwPictureNo","byCheckStatus","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","dwFingerPrintLen","byEnableCardReader","byFingerPrintID","byFingerType","byRes1","byFingerData","byEmployeeNo","byLeaderFP","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byCardReaderRecvStatus","byFingerPrintID","byFingerType","byTotalStatus","byRecvStatus","byErrorMsg","dwCardReaderNo","byEmployeeNo","byErrorEmployeeNo","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byCardNo","byEnableCardReader","dwFingerPrintNum","byFingerPrintID","byCallBackMode","byRes2","byEmployeeNo","byRes1"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byRes1","struValidPeriodCfg","byGroupName","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","bySwipeIntervalTimeout","byRes1","struGroupCfg","byRes2"})
    ...
    @Structure.FieldOrder({"byEnable","byEnableOfflineVerifyMode","byRes1","dwTemplateNo","struGroupCombination"})
    ...
    @Structure.FieldOrder({"byEnable","byMemberNum","bySequenceNo","byRes","dwGroupNo"})
    ...
    //自定义结构体，用于二维数组转换
    @Structure.FieldOrder({"struPlanCfgDay"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byRes1","struPlanCfg","byRes2"})
    ...
    @Structure.FieldOrder({"byEnable","byDoorStatus","byVerifyMode","byRes","struTimeSegment"})
    ...
    @Structure.FieldOrder({"struBeginTime","struEndTime"})
    ...
    @Structure.FieldOrder({"byHour","byMinute","bySecond","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwWeekPlanNumber","wLocalControllerID","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byRes1","byTemplateName","dwWeekPlanNo","dwHolidayGroupNo","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwPlanTemplateNumber","wLocalControllerID","byRes"})
    ...
    @Structure.FieldOrder({"struFace","struLeftEye","struRightEye","struLeftMouth","struRightMouth","struNoseTip"})
    ...
    @Structure.FieldOrder({"dwSize","dwFaceTemplate1Size","pFaceTemplate1Buffer","dwFaceTemplate2Size","pFaceTemplate2Buffer","dwFacePicSize","pFacePicBuffer","byFaceQuality1","byFaceQuality2","byCaptureProgress","byFacePicQuality","dwInfraredFacePicSize","pInfraredFacePicBuffer","byInfraredFacePicQuality","byRes1","struFeature","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","lpRequestUrl","dwRequestUrlLen","lpInBuffer","dwInBufferSize","dwRecvTimeOut","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","lpOutBuffer","dwOutBufferSize","dwReturnedXMLSize","lpStatusBuffer","dwStatusSize","byRes"})
    ...
    //报警场景信息
    @Structure.FieldOrder({"dwSceneID","bySceneName","byDirection","byRes1","struPtzPos","byRes2"})
    ...
    // 方向结构体
    @Structure.FieldOrder({"struStartPoint","struEndPoint"})
    ...
    // 交通事件信息
    @Structure.FieldOrder({"byRuleID","byRes1","byRuleName","dwAIDType","struDirect","bySpeedLimit","byCurrentSpeed","byVehicleEnterState","byState","byParkingID","dwAIDTypeEx","byRes2"})
    ...
    //交通取证报警
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","dwIllegalType","dwIllegalDuration","byMonitoringSiteID","byDeviceID","struDevInfo","struSceneInfo","struBeginRecTime","struEndRecTime","struAIDInfo","struPlateInfo","struVehicleInfo","dwPicNum","struPicInfo","bySpecificVehicleType","byLaneNo","byRes1","struTime","dwSerialNo","byVehicleAttribute","byPilotSafebelt","byCopilotSafebelt","byPilotSunVisor","byCopilotSunVisor","byPilotCall","byRes2","byIllegalCode","wCountry","byRegion","byCrossLine","byParkingSerialNO","byCrossSpaces","byAngledParking","byAlarmValidity","byDoorsStatus","dwXmlLen","pXmlBuf","byVehicleHeadTailStatus","byBrokenNetHttp","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","dwConfigMode","byPicModeType","byRelateType","byRes"})
    ...
    //字符叠加每一条信息结构体
    @Structure.FieldOrder({"byRes1","byItemType","byChangeLineNum","bySpaceNum","byRes2","byEnablePos","wStartPosTop","wStartPosLeft","byItemTypeCustom","byRes"})
    ...
    @Structure.FieldOrder({"struSingleItem","dwLinePercent","dwItemsStlye","wStartPosTop","wStartPosLeft","wCharStyle","wCharSize","wCharInterval","byRes1","dwForeClorRGB","dwBackClorRGB","byColorAdapt","byParamFillZeroEnble","byPlateLeftCornerEnable","byRes2","wStartSPicPosTop","wStartSPicPosLeft","byOsdLocate","byRes"})
    ...
    //叠加项具体信息
    @Structure.FieldOrder({"bySite","byRoadNum","byInstrumentNum","byDirection","byDirectionDesc","byLaneDes","byRes1","byMonitoringSite1","byMonitoringSite2","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byRes1","struOverLapItemV50","struOverLapInfo","byRes"})
    ...
    //人体特征识别结果结构体
    @Structure.FieldOrder({"byRes3","bySex","byEyeGlass","byRes4","byDeviation","byRes0","byMask","bySmile","byFaceExpression","byRes1","byRes2","byHat","byRes"})
    ...
    //特征抓拍附加信息结构体
    @Structure.FieldOrder({"struFacePicRect","iSwingAngle","iTiltAngle","dwPupilDistance","byBlockingState","byFaceSnapThermometryEnabled","byIsAbnomalTemperature","byThermometryUnit","struEnterTime","struExitTime","fFaceTemperature","fAlarmTemperature","byRes"})
    ...
    //特征抓拍信息
    @Structure.FieldOrder({"dwRelativeTime","dwAbsTime","dwSnapFacePicID","dwSnapFacePicLen","struDevInfo","byFaceScore","bySex","byGlasses","byRes2","byDeviation","byGroup","byFacePicQuality","byRes1","dwUIDLen","pUIDBuffer","fStayDuration","pBuffer1"})
    ...
    //籍贯参数
    @Structure.FieldOrder({"wNationalityID","wProvinceID","wCityID","wCountyID","dwCode"})
    ...
    @Structure.FieldOrder({"bySex","byCertificateType","byBirthDate","byName","struNativePlace","byCertificateNumber","dwPersonInfoExtendLen","pPersonInfoExtend","byGroup","byRes2"})
    ...
    //禁止名单报警信息
    @Structure.FieldOrder({"struBlockListInfo","dwBlockListPicLen","dwFDIDLen","pFDID","dwPIDLen","pPID","wThresholdValue","byRes","pBuffer1"})
    ...
    //禁止名单信息
    @Structure.FieldOrder({"dwSize","dwRegisterID","dwGroupNo","byType","byLevel","byRes1","struAttribute","byRemark","dwFDDescriptionLen","pFDDescriptionBuffer","dwFCAdditionInfoLen","pFCAdditionInfoBuffer","byRes2"})
    ...
    //禁止名单比对结果报警上传
    @Structure.FieldOrder({"dwSize","fSimilarity","struSnapInfo","struBlockListInfo","sStorageIP","wStoragePort","byMatchPicNum","byPicTransType","dwSnapPicLen","pSnapPicBuffer","struRegion","dwModelDataLen","pModelDataBuffer","byModelingStatus","byLivenessDetectionStatus","cTimeDifferenceH","cTimeDifferenceM","byMask","bySmile","byContrastStatus","byBrokenNetHttp"})
    ...
    //交通事件报警(扩展)
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","struDevInfo","struAIDInfo","struSceneInfo","dwPicDataLen","pImage","byDataType","byLaneNo","wMilliSecond","byMonitoringSiteID","byDeviceID","dwXmlLen","pXmlBuf","byTargetType","byRuleID","wDevInfoIvmsChannelEx","byBrokenNetHttp","byRes","dwPlateSmallPicDataLen","pPlateSmallImage"})
    ...
    //交通统计信息报警(扩展)
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","struDevInfo","struTPSInfo","byMonitoringSiteID","byDeviceID","dwStartTime","dwStopTime","byRes"})
    ...
    @Structure.FieldOrder({"byRuleName","byRuleID","byLaneType","byTrafficState","byLaneNo","dwVaryType","dwTpsType","dwLaneVolume","dwLaneVelocity","dwTimeHeadway","dwSpaceHeadway","fSpaceOccupyRation","fTimeOccupyRation","dwLightVehicle","dwMidVehicle","dwHeavyVehicle","struLaneQueue","struRuleLocation","dwOversizeVehicle","byRes2"})
    ...
    @Structure.FieldOrder({"dwLanNum","struLaneParam","dwSceneID","byRes"})
    ...
    // 车道队列结构体
    @Structure.FieldOrder({"struHead","struTail","dwLength"})
    ...
    //TPS统计过车数据上传
    @Structure.FieldOrder({"dwSize","dwChan","struTPSStatisticsInfo","byRes"})
    ...
    // 交通参数统计信息
    @Structure.FieldOrder({"byStart","byCMD","byRes","wDeviceID","wDataLen","byTotalLaneNum","byRes1","struStartTime","dwSamplePeriod","struLaneParam"})
    ...
    //统计信息
    @Structure.FieldOrder({"byLane","bySpeed","byRes","dwLightVehicle","dwMidVehicle","dwHeavyVehicle","dwTimeHeadway","dwSpaceHeadway","fSpaceOccupyRation","fTimeOccupyRation","byRes1"})
    ...
    //TPS实时过车数据上传
    @Structure.FieldOrder({"dwSize","dwChan","struTime","struTPSRealTimeInfo","pAddInfoBuffer","byAddInfoFlag","byRes1","dwDeviceIDEx","byRes"})
    ...
    //实时信息
    @Structure.FieldOrder({"byStart","byCMD","wSpaceHeadway","wDeviceID","wDataLen","byLane","bySpeed","byLaneState","byQueueLen","wLoopState","wStateMask","dwDownwardFlow","dwUpwardFlow","byJamLevel","byVehicleDirection","byJamFlow","byChannelizationLane","byVehicleType","byRes1","wTimeHeadway"})
    ...
    @Structure.FieldOrder({"wYear","byMonth","byDay","byHour","byMinute","bySecond","byLocalOrUTC","wMillisecond","cTimeDifferenceH","cTimeDifferenceM"})
    ...
    //事件搜索条件
    @Structure.FieldOrder({"wMajorType","wMinorType","struStartTime","struEndTime","byLockType","byValue","byRes","uSeniorParam"})
    ...
    //审讯事件搜索条件
    @Structure.FieldOrder({"byRoomIndex","byRes1","sInquestInfo","byRes2"})
    ...
    //事件搜索条件
    @Structure.FieldOrder({"wMajorType","wMinorType","struStartTime","struEndTime","byLockType","byQuickSearch","byRes","uSeniorParam"})
    ...
    @Structure.FieldOrder({"wAlarmInNo","byRes"})
    ...
    //移动侦测
    @Structure.FieldOrder({"wMotDetChanNo","byRes"})
    ...
    //异常行为检测
    @Structure.FieldOrder({"wChanNo","byRuleID","byDriverBehaviortType","byADASType","byGSensorType","bySensorInType","byRes"})
    ...
    //审讯事件搜索条件
    @Structure.FieldOrder({"byRoomIndex","byRes"})
    ...
    //智能侦测查找条件 ，通道号按值表示
    @Structure.FieldOrder({"byAll","byRes1","wChanNo","byRes"})
    ...
    @Structure.FieldOrder({"struIDInfo","dwCmdType","byBackupVolumeNum","byRes1","byArchiveLabel","byRes"})
    ...
    //pos录像
    @Structure.FieldOrder({"wChannel","byAllChan","byCaseSensitive","byCombinateMode","byRes1","sKeyWord","byRes"})
    ...
    @Structure.FieldOrder({"byCaseNo","byCaseName","byLitigant1","byLitigant2","byChiefJudge","byCaseType","byRes"})
    ...
    //门禁事件搜索条件
    @Structure.FieldOrder({"dwMajor","dwMinor","byCardNo","byName","byMACAddr","byRes"})
    ...
    //非视频联动事件搜索条件
    @Structure.FieldOrder({"wDeviceType","wEventType","wChannel","byAllChan","byCaseSensitive","byCombinateMode","bySearchType","sKeyWord","wZoneNo","byRes"})
    ...
    //查找返回结果
    @Structure.FieldOrder({"wMajorType","wMinorType","struStartTime","struEndTime","byChan","byChanEx","byRes","uSeniorRet"})
    ...
    //报警输入结果
    @Structure.FieldOrder({"dwAlarmInNo","byRes"})
    ...
    //审讯事件
    @Structure.FieldOrder({"byRoomIndex", "byDriveIndex", "byRes1", "dwSegmentNo", "wSegmetSize", "wSegmentState", "byRes2"})
    ...
    //查找返回结果
    @Structure.FieldOrder({"wMajorType","wMinorType","struStartTime","struEndTime","struAddr","wChan","byRes","uSeniorRet"})
    ...
    //移动侦测结果
    @Structure.FieldOrder({"dwMotDetNo","byRes"})
    ...
    //异常行为检测结果
    @Structure.FieldOrder({"dwChanNo","byRuleID","byRes1","byRuleName","uEvent","byRes"})
    ...
    //流id录像查询结果
    @Structure.FieldOrder({"dwRecordType","dwRecordLength","byLockFlag","byDrawFrameType","byPosition","byRes1","byFileName","dwFileIndex","byTapeIndex","byFileNameEx","byRes"})
    ...
    //POS录像查询结果
    @Structure.FieldOrder({"dwChanNo","byRes"})
    public static class EVENT_POSRET_V50 extends Structure {
        public int dwChanNo;        //触发产生pos事件的通道
        public byte[] byRes = new byte[796];
    }
    @Structure.FieldOrder({"byRoomIndex","byDriveIndex","wSegmetSize","dwSegmentNo","bySegmentState","byCaseType","byRes","byCaseNo","byCaseName","byLitigant1","byLitigant2","byChiefJudge","byRes1"})
    ...
    @Structure.FieldOrder({"struStartTime","struStopTime","byRoomIndex","byDriveIndex","wSegmetSize","dwSegmentNo","byRes"})
    ...
    @Structure.FieldOrder({"dwResumeNum","struResumeSegment","byResumeMode","byRes"})
    ...
    //报警信息查询条件结构体
    @Structure.FieldOrder({"dwSize","strStartTime","strStopTime","dwAlarmComm","sAlarmUID","byRes"})
    ...
    //报警信息查询结果结构体
    @Structure.FieldOrder({"dwSize","dwAlarmComm","dwAlarmLen","pAlarmInfo","struAlarmer","byRes"})
    ...
    @Structure.FieldOrder({"pAlarmData","dwAlarmDataLen","byDataType","byPicturesNumber","byRes","pPicPackData","byRes1"})
    ...
    @Structure.FieldOrder({"byExceptionCbDirectly","byNotSplitRecordFile","byResumeUpgradeEnable","byAlarmJsonPictureSeparate","byRes","i64FileSize","dwResumeUpgradeTimeout","byRes1"})
    ...
    @Structure.FieldOrder({"wLocalBindTcpMinPort","wLocalBindTcpMaxPort","byRes"})
    ...
    @Structure.FieldOrder({"dwCheckOnlineTimeout","dwCheckOnlineNetFailMax","byRes"})
    ...
    @Structure.FieldOrder({"dwPicLen","byPicType","byRes","szFilename","pPicData"})
    ...
    @Structure.FieldOrder({"dwSize","byFocusMode","byAutoFocusMode","wMinFocusDistance","byZoomSpeedLevel","byFocusSpeedLevel","byOpticalZoom","byDigtitalZoom","fOpticalZoomLevel","dwFocusPos","byFocusDefinitionDisplay","byFocusSensitivity","byRes1","dwRelativeFocusPos","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwSerialType","bySerialNum","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","wPresetNum","byRes1","byName","wPanPos","wTiltPos","wZoomPos","byRes"})
    ...
    //Sensor信息
    @Structure.FieldOrder({"bySensorType","byRes","fHorWidth","fVerWidth","fFold"})
    ...
    //球机位置信息
    @Structure.FieldOrder({"fPanPos","fTiltPos","fZoomPos","byRes"})
    ...
    @Structure.FieldOrder({"fSec","byDegree","byMinute","byRes"})
    ...
    //GIS信息上传
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","struDevInfo","fAzimuth","byLatitudeType","byLongitudeType","byRes1","struLatitude","struLongitude","fHorizontalValue","fVerticalValue","fVisibleRadius","fMaxViewRadius","struSensorParam","struPtzPos","byRes"})
    ...
    @Structure.FieldOrder({"byHour","byMinute","bySecond","byRes","wMilliSecond","byRes1"})
    ...
    @Structure.FieldOrder({"struStartTime","struStopTime"})
    ...
    @Structure.FieldOrder({"dwSize","byMode","byBrightnessLimit","bySupplementLightMode","byMixedLightRegulatMode","byLrLightBrightness","byHighLrLightBrightness","byHighBrightnessLimit","byLowLrLightBrightness","struSchedTime","byLowBrightnessLimit","byWhiteLightBrightness","byRes1"})
    ...
    @Structure.FieldOrder({"dwHandleType","dwMaxRelAlarmOutChanNum","dwRelAlarmOut","byRes"})
    ...
    @Structure.FieldOrder({"dwEnablePresetChan","dwPresetPointNo"})
    ...
    @Structure.FieldOrder({"dwEnableCruiseChan","dwCruiseNo"})
    ...
    @Structure.FieldOrder({"dwEnablePtzTrackChan","dwPtzTrackNo"})
    ...
    @Structure.FieldOrder({"dwSize","struHandleException","dwRelRecordChan","struPresetChanInfo","struCruiseChanInfo","struPtzTrackInfo","byDirection","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","szFDID","byRes"})
    ...
    //导入人脸数据条件
    @Structure.FieldOrder({"dwSize","szFDID","byConcurrent","byCover","byCustomFaceLibID","byPictureSaveMode","byIdentityKey","byRes"})
    ...
    @Structure.FieldOrder({"pSendData","dwSendDataLen","struTime","byPicType","byPicURL","byUploadModeling","byRes1","dwPicMangeNo","sPicName","dwPicDisplayTime","pSendAppendData","dwSendAppendDataLen","byRes"})
    ...
    @Structure.FieldOrder({"byRoomIndex","byFileType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwNum","dwRwSelectPara","dwModeSelect","byRes","dwStartCDRW","dwHdExcp","dwInterval","sLable"})
    ...
    @Structure.FieldOrder({"dwType","strCDRWNum","struInquestStartTime","byRes"})
    ...
    @Structure.FieldOrder({"dwEnable","dwStatus","dwVolumn","dwFreeSpace","dwTimeLeft","byCDType","byRes"})
    ...
    //实时温度检测条件参数
    @Structure.FieldOrder({"dwSize","dwChan","byRuleID","byMode","wInterval","byRes2"})
    ...
    //点测温实时信息
    @Structure.FieldOrder({"fTemperature","struPoint","byRes"})
    ...
    //框/线测温实时信息
    @Structure.FieldOrder({"fMaxTemperature","fMinTemperature","fAverageTemperature","fTemperatureDiff","struRegion","byRes"})
    ...
    //实时温度信息
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","szRuleName","byRuleID","byRuleCalibType","wPresetNo","struPointThermCfg","struLinePolygonThermCfg","byThermometryUnit","byDataType","byRes1","bySpecialPointThermType","fCenterPointTemperature","fHighestPointTemperature","fLowestPointTemperature","struHighestPoint","struLowestPoint","byIsFreezedata","byRes"})
    ...
    @Structure.FieldOrder({"fPan","fTilt","fZoom","dwFocus","byRes"})
    ...
    //测温模式配置
    @Structure.FieldOrder({"dwSize","byMode","byThermometryROIEnabled","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","wPresetNo","byRes"})
    ...
    @Structure.FieldOrder({"byEnabled","byRuleID","wDistance","fEmissivity","byDistanceUnit","byRes","byReflectiveEnabled","fReflectiveTemperature","szRuleName","byemissivityMode","byRes1","byRuleCalibType","struPoint","struRegion"})
    ...
    @Structure.FieldOrder({"dwSize","wPresetNo","byRes","struPresetInfo"})
    ...
    //温差报警
    @Structure.FieldOrder({"dwSize","dwChannel","byAlarmID1","byAlarmID2","wPresetNo","byAlarmLevel","byAlarmType","byAlarmRule","byRuleCalibType","struPoint","struRegion","fRuleTemperatureDiff","fCurTemperatureDiff","struPtzInfo","dwPicLen","dwThermalPicLen","dwThermalInfoLen","pPicBuff","pThermalPicBuff","pThermalInfoBuff","byThermometryUnit","byPicTransType","byRes1","fToleranceTemperature","dwAlarmFilteringTime","dwVisibleChannel","byRes"})
    ...
    //船只检测报警上传
    @Structure.FieldOrder({"dwSize","struDevInfo","dwRelativeTime","dwAbsTime","byShipsNum","byShipsNumHead","byShipsNumEnd","byPicTransType","struShipInfo","dwPicLen","dwThermalPicLen","pPicBuffer","pThermalPicBuffer","wDevInfoIvmsChannelEx","byTimeDiffFlag","cTimeDifferenceH","cTimeDifferenceM","bySID","byRes1","szSceneName","byRes"})
    ...
    //船只信息
    @Structure.FieldOrder({"fShipsLength","fShipsHeight","fShipsWidth","fShipsSpeed","byShipsDirection","byShipsDetState","byTriggerLineID","byRes","struShipsRect"})
    ...
    @Structure.FieldOrder({"dwSize","dwCount","struArrayInfo"})
    ...
    @Structure.FieldOrder({"byBga","byBgaState","wBgaPercentage","byRes"})
    ...
    // 阵列信息
    @Structure.FieldOrder({"wArrayID","byRaidMode","byStatus","dwHCapacity","dwLCapacity","dwHFreeSpace","dwLFreeSpace","byArrayName","byPDCount","bySpareCount","byRes1","wPDSlots","wSparePDSlots","struBgaInfo","wPDSlotsPartTwo","wSparePDSlotsPartTwo","byRes2"})
    ...
    //物理磁盘
    @Structure.FieldOrder({"wPhySlot","byType","byStatus","byMode","dwHCapacity","dwLCapacity","byArrrayName","wArrayID","byArrayInformation","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwDeviceStatic","struHardDiskStatic","struChanStatic","dwHasAlarmInStatic","dwHasAlarmOutStatic","dwLocalDisplay","byAudioInChanStatus","byRes1","fHumidity","fTemperature","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byFindHardByCond","byFindChanByCond","byRes1","dwFindHardStatus","dwFindChanNo","byRes"})
    ...
    @Structure.FieldOrder({"byMode","byRes1","uRegion","byRes"})
    ...
    //单组IO测速参数
    @Structure.FieldOrder({"byEnable","byTrigCoil1","byCoil1IOStatus","byTrigCoil2","byCoil2IOStatus","byRelatedDriveWay","byTimeOut","byRelatedIOOutEx","dwDistance","byCapSpeed","bySpeedLimit","bySpeedCapEn","bySnapTimes1","bySnapTimes2","byBigCarSpeedLimit","byBigCarSignSpeed","byIntervalType","wInterval1","wInterval2","byRelatedIOOut","byFlashMode","byLaneType","byCarSignSpeed","byUseageType","struPlateRecog","byRelaLaneDirectionType","byLowSpeedLimit","byBigCarLowSpeedLimit","byLowSpeedCapEn","byEmergencyCapEn","byRes"})
    ...
    //牌识参数
    @Structure.FieldOrder({"byDefaultCHN","byEnable","dwRecogMode","byVehicleLogoRecog","byProvince","byRegion","byCountry","wPlatePixelWidthMin","wPlatePixelWidthMax","byRes"})
    ...
    //卡口IO测速参数
    @Structure.FieldOrder({"struPlateRecog","struSingleIOSpeed","byRes"})
    ...
    @Structure.FieldOrder({"iRes","dwCity"})
    ...
    @Structure.FieldOrder({"byIntervalType","byRes1","wInterval","byRes"})
    ...
    @Structure.FieldOrder({"byRelatedDriveWay","bySpeedCapEn","bySignSpeed","bySpeedLimit","bySnapTimes","byBigCarSignSpeed","byBigCarSpeedLimit","byRelatedIOOutEx","struInterval","byRelatedIOOut","byFlashMode","byLowSpeedLimit","byBigCarLowSpeedLimit","byRelaLaneDirectionType","struPlateRecog","struLine"})
    ...
    @Structure.FieldOrder({"struLaneRect","byTrigFlag","byTrigSensitive","byRelatedIOOut","byFlashMode","byLaneType","byEnableRadar","struLane","byUseageType","byCarDriveDirect","byRes"})
    ...
    @Structure.FieldOrder({"byRadarType","byLevelAngle","wRadarSensitivity","wRadarSpeedValidTime","byRes1","fLineCorrectParam","iConstCorrectParam","byRes2"})
    ...
    //卡口虚拟线圈触发参数
    @Structure.FieldOrder({"byRelatedLaneNum","byIsDisplay","byLoopPos","byPolarLenType","byDayAuxLightMode","byVideoLaneNO","byVideoLowTh","byVideoHighTh","byRecordMode","bySnapMode","bySpeedDetector","byRes2","wResolutionX","wResolutionY","dwDayInitExp","dwDayMaxExp","dwNightExp","dwSnapExp","byDayInitGain","byDayMaxGain","byNightGain","bySnapGain","dwSceneMode","struGeogLocation","struPlateRecog","struVtCoil","struRadar","struLine","dwVioDetectType","byDebugMode","byRes"})
    ...
    //车道属性参数结构
    @Structure.FieldOrder({"byUseageType","byDirectionType","byCarDriveDirect","byRes"})
    ...
    //视频电警线结构
    @Structure.FieldOrder({"struLine","byLineType","byRes"})
    ...
    @Structure.FieldOrder({"byVehicleCapMode","byNoVehicleCapMode","byPasserCapMode","byRes"})
    ...
    //size = 128
    @Structure.FieldOrder({"dwCapShutter","wCapGain","byRes","dwDayTimeVideoShutter","wDayTimeVideoGain","wNightVideoGain","wNightVideoShutter","byRes1"})
    ...
    @Structure.FieldOrder({"byLaneNO","bySignSpeed","bySpeedLimit","byBigCarSignSpeed","byBigCarSpeedLimit","bySpeedCapEn","byCaptureCount","byRelatedIOOut","byFlashMode","byEnableRadar","byChangeLaneEnable","byChangeLaneCapNo","dwCapTarget","struInterval","byRes3","struLane","struLeftLaneLine","struRightLaneLine","struPlateRecog","struTraceArea","struForwardTrigLine","struBackwardTrigLine","struLeftTrigLine","struRightTrigLine","byRes4"})
    ...
    @Structure.FieldOrder({"byLaneNum","bySceneMode","byRoadExpBright","byPlateExpBright","struDetectArea","struCapMode","struEcParam","struLaneParam","struPlateRecog","struGeogLocation","byRes"})
    ...
    //抓拍机4.0新增
    @Structure.FieldOrder({"byLaneNO","byFlashMode","bySignSpeed","bySpeedLimit","bySignLowSpeed","byLowSpeedLimit","byBigCarSignSpeed","byBigCarSpeedLimit","byBigCarSignLowSpeed","byBigCarLowSpeedLimit","bySnapTimes","byDriveLineSnapTime","byHighSpeedSnapTime","byLowSpeedSnapTime","byBanSnapTime","byReverseSnapTime","byRelatedDriveWay","byLaneType","byRelaLaneDirectionType","byRes1","byChangeLaneEnable","byChangeLaneCapNo","dwVioDetectType","dwRelatedIOOut","struTrigLine","struLineLeft","struPlateRecog","struLane","struInterval","byRes2"})
    ...
    @Structure.FieldOrder({"byLaneNum","byCapType","byCapMode","bySecneMode","bySpeedMode","byLineRuleEffect","byRes1","struLeftTrigLine","struRigtTrigLine","struLaneBoundaryLine","struDetectArea","struGeogLocation","struLaneParam","struPlateRecog","byRes2"})
    ...
    //卡口RS485车检器触发参数
    @Structure.FieldOrder({"byRelatedLaneNum","byTriggerSpareMode","byFaultToleranceTime","byRes1","struPlateRecog","struLane","byRes"})
    ...
    //卡口RS485雷达触发参数
    @Structure.FieldOrder({"byRelatedLaneNum","byRes1","struPlateRecog","struLane","struRadar","byRes"})
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    //单个触发参数结构
    @Structure.FieldOrder({"byEnable","byRes1","dwTriggerType","uTriggerParam","byRes"})
    ...
    //触发参数结构
    @Structure.FieldOrder({"dwSize","struTriggerParam","byRes"})
    ...
    //单个IO接入信号灯参数
    @Structure.FieldOrder({"byLightType","byRelatedIO","byRedLightState","byRes"})
    ...
    //IO接入信号灯参数
    @Structure.FieldOrder({"struIOLight","byRes"})
    ...
    //单个485接入信号灯参数
    @Structure.FieldOrder({"byLightType","byRelatedLightChan","byInputLight","byRelatedYLightChan","byRes"})
    ...
    //485接入信号灯参数
    @Structure.FieldOrder({"struRS485Light","byRes"})
    ...
    @Structure.FieldOrder({"wLeft","wTop","wRight","wBottom"})
    ...
    //单组视频检测交通信号灯参数结构
    @Structure.FieldOrder({"byLightNum","byStraightLight","byLeftLight","byRightLight","byRedLight","byGreenLight","byYellowLight","byYellowLightTime","struLightRect","byRes"})
    ...
    @Structure.FieldOrder({"struTrafficLight","byRes"})
    ...
    //交通信号灯参数结构
    @Structure.FieldOrder({"bySource","byRes1","struLightAccess","byRes"})
    ...
    //违规检测参数结构
    @Structure.FieldOrder({"dwVioDetectType","byDriveLineSnapTimes","byReverseSnapTimes","wStayTime","byNonDriveSnapTimes","byChangeLaneTimes","bybanTimes","byDriveLineSnapSen","wSnapPosFixPixel","bySpeedTimes","byTurnAroundEnable","byThirdPlateRecogTime","byPostSnapTimes","byRes1","wStopLineDis","byRes"})
    ...
    //违规检测线参数结构
    @Structure.FieldOrder({"struLaneLine","struStopLine","struRedLightLine","struCancelLine","struWaitLine","struRes"})
    ...
    //单个车道视频电警触发参数结构
    @Structure.FieldOrder({"byLaneNO","bySensitivity","byEnableRadar","byRelaLaneDirectionType","struLane","struVioDetect","struLine","struPlateRecog","byRecordEnable","byRecordType","byPreRecordTime","byRecordDelayTime","byRecordTimeOut","byCarSpeedLimit","byCarSignSpeed","bySnapPicPreRecord","struInterval","byRes"})
    ...
    //视频电警触发参数结构
    @Structure.FieldOrder({"byEnable","byLaneNum","byLogicJudge","byRes1","struPlateRecog","struTrafficLight","struLaneParam","struLaneBoundaryLine","struLeftLine","struRightLine","struTopZebraLine","struBotZebraLine","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwTriggerType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwChannel","dwTriggerMode","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwMode","uVideoTrigger","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","struAddr","wServerPort","bySeverProtocolType","byStatus","sDeviceId","sPassWord","sPlatformEhomeVersion","byNetWork","byAddressType","byProtocolVersion","byRes1","sDomainName","byEnable","byRes"})
    ...
    //设置完全获取出厂值
    @Structure.FieldOrder({"dwSize","dwChannel","byRes"})
    public static class NET_DVR_COMPLETE_RESTORE_INFO extends Structure {
        public int dwSize; //结构体长度
        public int dwChannel; //通道号
        public byte[] byRes = new byte[64];
    }
    @Structure.FieldOrder({"lpCondBuffer","dwCondSize","lpOutBuffer","dwOutSize","lpStatusBuffer","dwStatusSize","dwRetSize","byRes"})
    ...
    @Structure.FieldOrder({"lpCondBuffer","dwCondSize","lpInBuffer","dwInSize","lpOutBuffer","dwOutSize","lpStatusBuffer","dwStatusSize","lpXmlBuffer","dwXmlSize","byDataType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","lpJsonData","dwJsonDataSize","lpPicData","dwPicDataSize","lpInfraredFacePicBuffer","dwInfraredFacePicSize","byRes"})
    ...
    @Structure.FieldOrder({"byDeviceID","byCardNo","byDevIP"})
    ...
    */
    ...
    @Structure.FieldOrder({"byBrightnessLevel","byContrastLevel","bySharpnessLevel","bySaturationLevel","byHueLevel","byEnableFunc","byLightInhibitLevel","byGrayLevel"})
    ...
    @Structure.FieldOrder({"byGainLevel","byGainUserSet","byRes","dwMaxGainValue"})
    ...
    @Structure.FieldOrder({"byWhiteBalanceMode","byWhiteBalanceModeRGain","byWhiteBalanceModeBGain","byRes"})
...
14-白炽灯 (IncandescentLamp)，15-暖光灯(Warm Light Lamp)，16-自然光(Natural Light) */
    ...
    @Structure.FieldOrder({"byExposureMode","byAutoApertureLevel","byRes","dwVideoExposureSet","dwExposureUserSet","dwRes"})
    ...
    @Structure.FieldOrder({"byGammaCorrectionEnabled","byGammaCorrectionLevel","byRes"})
    ...
    @Structure.FieldOrder({"byWDREnabled","byWDRLevel1","byWDRLevel2","byWDRContrastLevel","byRes"})
    ...
    @Structure.FieldOrder({"byDayNightFilterType","bySwitchScheduleEnabled","byBeginTime","byEndTime","byDayToNightFilterLevel","byNightToDayFilterLevel","byDayNightFilterTime","byBeginTimeMin","byBeginTimeSec","byEndTimeMin","byEndTimeSec","byAlarmTrigState"})
    ...
    @Structure.FieldOrder({"byBacklightMode","byBacklightLevel","byRes1","dwPositionX1","dwPositionY1","dwPositionX2","dwPositionY2","byRes2"})
    ...
    @Structure.FieldOrder({"byDigitalNoiseRemoveEnable","byDigitalNoiseRemoveLevel","bySpectralLevel","byTemporalLevel","byDigitalNoiseRemove2DEnable","byDigitalNoiseRemove2DLevel","byRes"})
    ...
    @Structure.FieldOrder({"byCaptureMod","byBrightnessGate","byCaptureGain1","byCaptureGain2","dwCaptureShutterSpeed1","dwCaptureShutterSpeed2","byRes"})
    ...
    @Structure.FieldOrder({"byMode","byLevel","byRes"})
    ...
    @Structure.FieldOrder({"byEnable","byLevel","byRes"})
    ...
    @Structure.FieldOrder({"byEnableCorridorMode","byRes"})

    public static class NET_DVR_CORRIDOR_MODE_CCD extends Structure {
        public byte byEnableCorridorMode; //是否启用走廊模式 0～不启用， 1～启用
        public byte[] byRes = new byte[11];
    }
    @Structure.FieldOrder({"byMode","byIRDistance","byShortIRDistance","byLongIRDistance"})
    ...
    @Structure.FieldOrder({"byMode","byPIrisAperture","byRes"})
    ...
    @Structure.FieldOrder({"byControlMode","bySensitivity","byTriggerMode","byBrightness","byAngle","byLimitBrightness","byEnabled","byIllumination","byLightAngle","byRes"})
    ...
    @Structure.FieldOrder({"byMode","byRes1","wCompensateTime","byRes2"})
    ...
    @Structure.FieldOrder({"byMode","byNormalLevel","byExpertLevel","byRes"})
    ...
    @Structure.FieldOrder({"bySceneType","byLightLevel","byGainLevel","byRes"})
    ...
    @Structure.FieldOrder({"byEnable","byRes"})

    public static class NET_DVR_OPTICAL_DEHAZE extends Structure {
        public byte byEnable; //0~不启用光学透雾，1~启用光学透雾
        public byte[] byRes = new byte[7];
    }
    @Structure.FieldOrder({"byMode","iHighTemperature","iLowTemperature","byRes"})
    ...
    @Structure.FieldOrder({"dwTimeout","fnStateCB","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwSendFlowSize","dwRecvFlowSize","byRes"})
    ...
    @Structure.FieldOrder({"sAESKey","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sDeviceName","wDeviceType","wDeviceProtocol","dwBaudRate","byDataBit","byStopBit","byParity","byFlowcontrol","byDuplex","byWorkMode","byChannel","bySerialType","byMode","byOutputDataType","byAddress","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","sDeviceName","wDeviceType","wDeviceProtocol","wAddress","byChannel","bySlotChan","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byEnable","byCoordinateType","byRes1","dwVideoWallNo","dwDisplayNo","struRectCfg","byRes2"})
    ...
    @Structure.FieldOrder({"dwSize","struDisplayParam","byRes2"})
    ...
    @Structure.FieldOrder({"dwDisplayNo","byDispChanType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwResolution","struRes","byVideoFormat","byDisplayMode","byBackgroundColor","byUseEDIDResolution","wLEDWidth","wLEDHeight","struBackColor","byLinkStatus","byRes2"})
    ...
    @Structure.FieldOrder({"strWalloutputParm"})
    ...
    boolean NET_DVR_PlayBackControl(int lPlayHandle, int dwControlCode, int dwInValue, Pointer LPOutValue);
...
//2007-11-30 V211支持以下接口 //11
    ...
    //gps相关结构定义
    @Structure.FieldOrder({"struBeginTime","struEndTime","dwInterval","byRes"})
    ...
    //按时间点查询
    @Structure.FieldOrder({"struTimePoint","byRes"})
    ...
    //gps查询参数定义
    @Structure.FieldOrder({"dwCmdType","gpsDataParam"})
    ...
    //gps数据结构定义
    @Structure.FieldOrder({"byDirection","bySvs","byLocateMode","wHDOP","wHeight","dwLatitude","dwLongitude","dwVehicleSpeed","dwVehicleDirection","byRes"})
    ...
    //gps返回数据结构定义
    @Structure.FieldOrder({"struGPSInfo","struTime","byRes"})
     ...
     */
    //设备抓图附加全屏测温数据结构体
    @Structure.FieldOrder({"dwSize","dwChannel","dwJpegPicLen","pJpegPicBuff","dwJpegPicWidth","dwJpegPicHeight","dwP2PDataLen","pP2PDataBuff","byIsFreezedata","byRes"})
    ...
    @Structure.FieldOrder({"year","month","dayOfWeek","day","hour","minute","second","milliSecond"})
    ...
    //全屏测温数据解析
    @Structure.FieldOrder({"u32RTDataType","u32FrmNum","u32StdStamp","stTime","u32Width","u32Height","u32Len","u32Fps","u32Chan"})
    ...
    @Structure.FieldOrder({"u32TmDataMode","u32TmScale","u32TmOffset","byIsFreezedata"})
    ...
    @Structure.FieldOrder({"u32MagicNo","u32HeaderSize","u32StreamType","u32StreamLen","stRTDataInfo","stFsSuppleInfo","res","u32CrcVal"})
    ...
    //测温规则温度信息
    @Structure.FieldOrder({"fMaxTemperature","fMinTemperature","fAverageTemperature","struHighestPoint","struLowestPoint","byIsFreezedata","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","dwRelativeTime","dwAbsTime","struDevInfo","wPanPos","wTiltPos","wZoomPos","byPicTransType","byRes1","dwPicDataLen","pBuffer","struRect","struPoint","wFireMaxTemperature","wTargetDistance","byStrategyType","byAlarmSubType","byPTZPosExEnable","byRes2","struPtzPosEx","dwVisiblePicLen","pVisiblePicBuf","pSmokeBuf","wDevInfoIvmsChannelEx","byRes3","byFireScanWaitMode","dwVisibleChannel","byTimeDiffFlag","cTimeDifferenceH","cTimeDifferenceM","byRes"})
    ...
    //模块服务配置结构体
    @Structure.FieldOrder({"dwSize","byIrLampServer","bytelnetServer","byABFServer","byEnableLEDStatus","byEnableAutoDefog","byEnableSupplementLight","byEnableDeicing","byEnableVisibleMovementPower","byEnableThermalMovementPower","byEnablePtzPower","byPowerSavingControl","byCaptureWithSupplimentLightEnabled","byRes"})
    ...
    @Structure.FieldOrder({"sUrl","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","lCardIndex","dwInterval","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","byType","byRes"})
    ...
    @Structure.FieldOrder({"dwSize","strBeginTime","strEndTime","byType","byRes"})
     ...
     * 月历录像分布查询条件结构体
     */
    @Structure.FieldOrder({"dwSize","struStreamInfo","wYear","byMonth","byDrawFrame","byStreamType","byLocalOrUTC","byRes"})
     ...
     * 月历录像分布查询结果结构体
     */
    @Structure.FieldOrder({"dwSize","byRecordDistribution","byHasEventRecode","byRes"})
    ...
    //GIS信息
    @Structure.FieldOrder({"dwSize","fAzimuth","fHorizontalValue","fVerticalValue","fVisibleRadius","fMaxViewRadius","byLatitudeType","byLongitudeType","byPTZPosExEnable","byRes1","struLatitude","struLongitude","struPtzPos","struSensorParam","struPtzPosEx","fMinHorizontalValue","fMaxHorizontalValue","fMinVerticalValue","fMaxVerticalValue","byRes"})
    ...
    //GBT28181协议的设备编码通道配置
    @Structure.FieldOrder({"dwSize","szVideoChannelNumID","byRes"})
    ...
    // 巡航路径配置条件结构体
    @Structure.FieldOrder({"dwSize","dwChan","wRouteNo","byRes"})
    ...
    // 巡航路径配置结构体
    @Structure.FieldOrder({"dwSize","struCruisePoint","byRes"})
    ...
    // 巡航点参数结构体
    @Structure.FieldOrder({"wPresetNo","wDwell","bySpeed","bySupport256PresetNo","byRes"})
...
interface PlayCtrl extends Library {
    ...
    @Structure.FieldOrder({"nWidth", "nHeight", "nStamp", "nType", "nFrameRate", "dwFrameNum"})
